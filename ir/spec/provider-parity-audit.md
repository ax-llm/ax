...
media-device handling, and network execution remain target-owned boundaries.
...
| Extra TS catalog providers | deferred feature | Removed or non-generated catalog providers are out of scope until product priority requires their wire mapping. |
...
Vertex/web-search routing, or additional provider clients selected by product
need rather than descriptor coverage pressure.
