...
- `src/ax/dsp/functions.ts` and `src/ax/dsp/generate.ts` for native tool calls, validation retries, infrastructure retries, and final public output cleanup.
- `src/ax/dsp/response/streaming.ts` for deterministic string delta folding.
