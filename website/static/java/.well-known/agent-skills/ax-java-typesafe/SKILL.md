...
```java
var model = Ax.ai("typesafe", Map.of("apiKey", apiKey, "trueThreshold", 0.9));
var triage = Ax.ax("ticket:string -> urgent:boolean(true \"Core task blocked\", false \"Routine request\"), team:class \"support, billing, engineering\"");
