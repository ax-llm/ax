...
Field processors rewrite the field value, a port extension; TypeScript's feedback processors (a result sent back to the model for another step) are in progress for this language.
