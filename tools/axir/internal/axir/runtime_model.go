...
func BuildRuntimeModel(core Module) (AxRuntimeModel, error) {
	...
	return AxRuntimeModel{
		...
		Features: map[string]bool{
			...
			"axai_vertex_routing":                          true,
			"axai_openai_prompt_caching":                   true,
			"axai_cache_cost_accounting":                   true,
			...
			"axagent_shared_runtime_session":               true,
			"axagent_shared_evidence_handoff":              true,
			"axagent_relevance_ranking":                    true,
			"axagent_auto_upgrade":                         true,
			"axagent_signature_update":                     true,
			...
			"axagent_runtime_profile_productization_alpha": true,
			"axagent_runtime_profile_policy":               true,
			"axagent_runtime_profile_package_policy":       true,
			...
			"axagent_stage_instructions":                   true,
			"axagent_evidence_citations":                   true,
			"axagent_playbook_config":                      true,
			"axagent_run_end_playbook_learning":            true,
			"axagent_playbook_verified_evolve":             true,
			...
			"axoptimize_ace_bullet_tag_normalization":      true,
			"axoptimize_ace_updated_bullet_ids":            true,
			"axoptimize_ace_empty_render":                  true,
			...
			"axmcp":                                        true,
			"axmcp_client":                                 true,
			"axmcp_streamable_http_transport":              true,
			...
			"axai_balancer_adaptive_routing":               true,
			"axai_balancer_adaptive_stats_store":           true,
			"axai_balancer_adaptive_events":                true,
			"axai_provider_incremental_streaming":          true,
			"axai_balancer_incremental_streaming":          true,
			"axai_host_processing_callbacks":               true,
			"axai_openai_compatible_catalog_clients":       true,
			"axai_provider_profile_registry":               true,
			"axai_provider_profile_transport_dispatch":     true,
			"axai_provider_profile_model_rules":            true,
			"axai_provider_profile_request_transforms":     true,
			"axai_provider_profile_operation_dialects":     true,
			"axai_realtime_audio_provider_operation":       true,
			"axai_realtime_audio_grammar_profiles":         true,
			"axai_grok_realtime_audio":                     true,
			"axai_gemini_live_audio":                       true,
			"axai_provider_realtime_audio_extensible":      true,
			...
			"anthropic_adaptive_thinking_display":          true,
			"anthropic_adaptive_sampling_suppression":      true,
