...
func BuildRuntimeModel(core Module) (AxRuntimeModel, error) {
	...
	return AxRuntimeModel{
		...
		Features: map[string]bool{
			...
			"axai_balancer_adaptive_buffered_streaming":    true,
			"axai_host_processing_callbacks":               true,
			"axai_openai_compatible_catalog_clients":       true,
			"axai_provider_azure_openai_descriptor":        true,
			"axai_provider_deepseek_descriptor":            true,
			"axai_provider_mistral_descriptor":             true,
			"axai_provider_reka_descriptor":                true,
			"axai_provider_cohere_descriptor":              true,
			"axai_provider_grok_descriptor":                true,
