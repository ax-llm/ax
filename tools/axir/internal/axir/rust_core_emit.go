...
var coreIntrinsicRust = map[CoreIntrinsic]string{
	...
	"intrinsic.math.exp":                "core_math_exp",
	"intrinsic.math.sqrt":               "core_math_sqrt",
	"intrinsic.math.cos":                "core_math_cos",
	"intrinsic.math.pow":                "core_math_pow",
	"intrinsic.math.random":             "core_math_random",
	...
	"intrinsic.list.sorted_strings":     "core_sorted_strings",
	...
	"intrinsic.json.parse_strict":                     "core_json_parse_strict",
	...
	"intrinsic.ai.stream_next":                        "core_ai_stream_next",
	"intrinsic.ai.stream_close":                       "core_ai_stream_close",
	"intrinsic.axgen.emit_delta":                      "core_axgen_emit_delta",
