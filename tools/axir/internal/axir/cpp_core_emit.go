...
var coreIntrinsicCpp = map[CoreIntrinsic]string{
	...
	IntrinsicMathSqrt:                  "Core::math_sqrt",
	IntrinsicMathCos:                   "Core::math_cos",
	IntrinsicMathPow:                   "Core::math_pow",
	IntrinsicMathRandom:                "Core::math_random",
	...
	IntrinsicStringIndexOf:             "Core::string_index_of",
	IntrinsicAIStreamOpen:              "Core::ai_stream_open",
	IntrinsicAIStreamNext:              "Core::ai_stream_next",
	IntrinsicAIStreamClose:             "Core::ai_stream_close",
	IntrinsicAxGenEmitDelta:            "Core::axgen_emit_delta",
