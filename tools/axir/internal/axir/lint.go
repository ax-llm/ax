...
func stringsHasAxSemanticPrefix(name string) bool {
	switch name {
	case "ax.ai.semantic", "ax.gen.semantic", "ax.provider.semantic", "ax.schema.semantic", "ax.signature.semantic", "ax.stream.semantic", "ax.template.semantic", "ax.tool.semantic", "ax.validate.semantic":
		return true
	default:
		return false
	}
