...
func EmitPython(model AxRuntimeModel, outDir string) error {
	...
	files := map[string]string{
		...
		"examples/astra_session_no_key.py":                            pySessionNoKeyExample,
...
func EmitJava(model AxRuntimeModel, outDir string) error {
	...
	files := map[string]string{
		...
		"examples/AstraSessionNoKeyExample.java":                      javaAstraSessionNoKeyExample,
...
func EmitCpp(model AxRuntimeModel, outDir string) error {
	...
	files := map[string]string{
		...
		"examples/astra_session_no_key.cpp":                     cppAstraSessionNoKeyExample,
...
func BuildCapabilityManifest(model AxRuntimeModel, target string) (CapabilityManifest, error) {
	...
	return CapabilityManifest{
		...
		CoreOwnedFeatureGroups: targetCoreOwnedFeatureGroups(target, []string{
			...
			"prompt",
			"stream",
			"structured-stream-routing",
			"structured-stream-delta",
			"axgen",
			...
			"axmcp",
			"axmcp-server-requests",
			"axmcp-modern-era",
			"axmcp-param-headers",
			"axmcp-cacheable-results",
			"axmcp-tasks-v2",
			"axmcp-tasks-v2-input-fulfillment",
			"axmcp-mrtr-roots",
			"axmcp-mrtr-elicitation",
			"axmcp-subscriptions-listen",
...
func BuildConformanceCoverageManifest(model AxRuntimeModel, target string) (ConformanceCoverageManifest, error) {
	...
	for _, entry := range []struct {
		...
		{"axmcp", "mcp", "client_discovery", "transport-boundary"},
		{"axmcp", "mcp", "modern_headers", "semantic"},
		{"axmcp", "mcp", "era_classification", "semantic"},
		{"axmcp", "mcp", "mutual_version", "semantic"},
		{"axmcp", "mcp", "request_meta", "semantic"},
		{"axmcp", "mcp", "extension_negotiation", "semantic"},
		{"axmcp", "mcp", "param_headers", "semantic"},
		{"axmcp", "mcp", "header_value", "semantic"},
		{"axmcp", "mcp", "cache_fold", "semantic"},
		{"axmcp", "mcp", "read_cache", "transport-boundary"},
		{"axmcp", "mcp", "tasks_v2_modern", "transport-boundary"},
	...
	case "go":
		return packageReadmeConfig{
			...
			NoKeyExamples: readmeLines(
				...
				"- `go run ./examples/mcp_modern_roundtrip`: modern MCP discovery, cache, task, and roots MRTR over an in-process HTTP loopback",
