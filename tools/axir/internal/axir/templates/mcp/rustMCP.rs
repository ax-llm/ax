...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
pub struct AxEventEnvelope { pub specversion:String,pub id:String,pub source:String,#[serde(rename="type")] pub r#type:String,pub subject:Option<String>,pub data:Value }
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all="camelCase")]
pub struct AxEventRoute { pub id:String,pub action:String,pub r#match:Value,pub target_id:Option<String>,pub require_authenticated:bool,pub ordering:String,pub debounce_ms:i64 }
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(rename_all="camelCase")]
...
pub trait AxEventClock { fn now(&self)->i64; }
pub trait AxEventStore { fn enqueue(&mut self,event:AxEventEnvelope,commands:Vec<AxEventCommand>)->AxResult<()>; }
pub struct AxEventRuntime { pub routes:Vec<AxEventRoute>,pub options:Value,pub descriptor:Value }
impl AxEventRuntime {
    pub fn new(routes:Vec<AxEventRoute>,options:Value)->AxResult<Self>{
        ...
        Ok(Self{routes,options,descriptor})
    }
    pub fn publish(&self,event:AxEventEnvelope,identity_scope:&str,trust:&str)->AxResult<Vec<AxEventCommand>>{
