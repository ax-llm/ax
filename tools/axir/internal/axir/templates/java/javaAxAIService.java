...
public interface AxAIService extends AiClient {
  ...
  default Map<String,Object> embedWithCancellation(Map<String,Object> request,Map<String,Object> options,AxCancellationToken cancellation)throws Exception{Map<String,Object> resolved=new java.util.LinkedHashMap<>(options==null?Map.of():options);resolved.put("cancellation",cancellation);return embed(request,resolved);}
  ...
  default Map<String,Object> chatWithCancellation(Map<String,Object> request,Map<String,Object> options,AxCancellationToken cancellation)throws Exception{Map<String,Object> resolved=new java.util.LinkedHashMap<>(options==null?Map.of():options);resolved.put("cancellation",cancellation);return chat(request,resolved);}
  ...
  default Map<String,Object> transcribeWithCancellation(Map<String,Object> request,Map<String,Object> options,AxCancellationToken cancellation)throws Exception{Map<String,Object> resolved=new java.util.LinkedHashMap<>(options==null?Map.of():options);resolved.put("cancellation",cancellation);return transcribe(request,resolved);}
  ...
  default Map<String,Object> speakWithCancellation(Map<String,Object> request,Map<String,Object> options,AxCancellationToken cancellation)throws Exception{Map<String,Object> resolved=new java.util.LinkedHashMap<>(options==null?Map.of():options);resolved.put("cancellation",cancellation);return speak(request,resolved);}
}
