...
Defined in: [src/ax/ai/reka/api.ts:263](#apidocs/httpsgithubcomax-llmaxblob3b79ada8d723949fcd8a76c2b6f48cf69d8394f8srcaxairekaapitsl263)

## Extends

- [`AxBaseAI`](#apidocs/classaxbaseai)\<[`AxAIRekaChatRequest`](#apidocs/typealiasaxairekachatrequest), `unknown`, [`AxAIRekaChatResponse`](#apidocs/typealiasaxairekachatresponse), [`AxAIRekaChatResponseDelta`](#apidocs/typealiasaxairekachatresponsedelta), `unknown`\>
...
> **new AxAIReka**(`__namedParameters`): [`AxAIReka`](#apidocs/classaxaireka)

Defined in: [src/ax/ai/reka/api.ts:270](#apidocs/httpsgithubcomax-llmaxblob3b79ada8d723949fcd8a76c2b6f48cf69d8394f8srcaxairekaapitsl270)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `__namedParameters` | `Readonly`\<`Omit`\<[`AxAIRekaArgs`](#apidocs/interfaceaxairekaargs), `"name"`\>\> |
