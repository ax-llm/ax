...
Defined in: https://github.com/ax-llm/ax/blob/76f1e53f33743ee460569bb94d0bd3620db6e328/src/ax/ai/azure-openai/api.ts#L38
...
> **new AxAIAzureOpenAI**(`__namedParameters`): [`AxAIAzureOpenAI`](/api/#03-apidocs/classaxaiazureopenai)

Defined in: https://github.com/ax-llm/ax/blob/76f1e53f33743ee460569bb94d0bd3620db6e328/src/ax/ai/azure-openai/api.ts#L42

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `__namedParameters` | `Readonly`\<`Omit`\<[`AxAIAzureOpenAIArgs`](/api/#03-apidocs/typealiasaxaiazureopenaiargs), `"name"` \| `"modelInfo"`\>\> |
