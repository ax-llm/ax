...
Defined in: [src/ax/ai/cohere/api.ts:286](#apidocs/httpsgithubcomax-llmaxblob3b79ada8d723949fcd8a76c2b6f48cf69d8394f8srcaxaicohereapitsl286)

## Extends

- [`AxBaseAI`](#apidocs/classaxbaseai)\<[`AxAICohereChatRequest`](#apidocs/typealiasaxaicoherechatrequest), [`AxAICohereEmbedRequest`](#apidocs/typealiasaxaicohereembedrequest), [`AxAICohereChatResponse`](#apidocs/typealiasaxaicoherechatresponse), [`AxAICohereChatResponseDelta`](#apidocs/typealiasaxaicoherechatresponsedelta), [`AxAICohereEmbedResponse`](#apidocs/typealiasaxaicohereembedresponse)\>
...
> **new AxAICohere**(`__namedParameters`): [`AxAICohere`](#apidocs/classaxaicohere)

Defined in: [src/ax/ai/cohere/api.ts:293](#apidocs/httpsgithubcomax-llmaxblob3b79ada8d723949fcd8a76c2b6f48cf69d8394f8srcaxaicohereapitsl293)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `__namedParameters` | `Readonly`\<`Omit`\<[`AxAICohereArgs`](#apidocs/interfaceaxaicohereargs), `"name"`\>\> |
