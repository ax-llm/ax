...
class AxAIAnthropicImpl
    ...
    createChatResp = (
        ...
        const showThoughts = this.currentPromptConfig?.thinkingTokenBudget !== 'none' &&
        ...
        }).filter(result => result.content !== '' || result.thought !== undefined || result.functionCalls !== undefined)
    ...
    createChatStreamResp = (
        ...
        if (resp.type === 'content_block_start') {
            ...
            if (contentBlock.type === 'thinking') {
                ...
                if (showThoughts) {
                    return {
                        results: [{ thought: contentBlock.thinking }],
                    }
                }
                return {
                    results: [{ content: '' }],
        ...
        if (resp.type === 'content_block_delta') {
            ...
            if (delta.type === 'thinking_delta') {
                ...
                if (showThoughts) {
                    return {
                        results: [{ thought: delta.thinking }],
                    }
                }
                return {
                    results: [{ content: '' }],
...
> {
    constructor({
        ...
        const supportFor = (model: AxAIAnthropicModel | AxAIAnthropicVertexModel) => {
