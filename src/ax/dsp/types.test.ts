...
describe('ParseSignature TypeScript type inference', () => {
  it('should handle fields with descriptions but no explicit types', () => {
    ...
    type TestSig =
      'searchQuery:string -> relevantContext "description", sources:string "desc"';
  ...
  it('should handle the original problematic signature', () => {
    type OriginalSig =
      'searchQuery:string -> sourceType:class "class1, class2, class3", relevantContext "context", sources:string';
