 ...
 */
export function createFunctionConfig(functionList?: AxInputFunctionType, definedFunctionCall?: FunctionCall, firstStep?: boolean): { functions: AxFunction[], functionCall: FunctionCall } {
