    ...
    const confFlow = flow.nodeExtended(
      ...
      'userInput:string -> analysis:string',
      {
        appendOutputs: [
          {
            name: 'confidence',
            type: f.number('Confidence score 0-1'),
          },
        ],
      }
    );
    ...
    const extendedFlow = flow.nodeExtended(
      ...
      'userInput:string -> analysis:string',
      {
        ...
        appendOutputs: [
          {
            name: 'confidence',
            type: f.number('Confidence score'),
          },
        ],
      }
    );
    ...
    expect(() =>
      flow.nodeExtended('test', 'userInput:string -> analysis:string', {
        appendInputs: [
          {
            name: 'category',
            type: f.class(['a', 'b'], 'Input category'),
          },
        ],
      })
