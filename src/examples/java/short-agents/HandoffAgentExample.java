...
public final class HandoffAgentExample {
  ...
  static final class OpenAIBackedAgentClient implements AiClient {
    ...
    public Map<String, Object> chat(Map<String, Object> request, Map<String, Object> options) throws Exception {
      ...
      if (rawModelAnswer == null) {
        Map<String, Object> response = inner.chat(Map.of("chat_prompt", List.of(Map.of("role", "user", "content", "Give a three-step path from typed generation to agents and optimization."))));
  ...
  public static void main(String[] args) throws Exception {
    ...
    AxAgent assistant = Ax.agent("question:string -> plan:string[], answer:string", Map.of("contextFields", List.of()));
    Map<String, Object> output = assistant.forward(stageClient, Map.of("question", "Give a three-step path from typed generation to agents and optimization."));
