...
const signature = 'story:string -> intent:string, dogColors:string[], dogName:string, dogAge:string, dogBreed:string';
...
// Test input
const input = {
    story: 'Once upon a time, there was a dog named Luki. Luki was a golden retriever. Luki was 2 months old. The colors of his fur are golden, white and brown.',
};
