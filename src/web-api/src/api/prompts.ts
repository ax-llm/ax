...
>(
  '"You are an AI chat agent. Use the provided agent description to guide your behavior. The context of the chat is provided in the chat history use it when responding to your query or performing a task. Respond in markdown. Use markdown codeblocks only for code." agentDescription, chatHistory?:string, context?:string, queryOrTask -> markdownResponse'
);
