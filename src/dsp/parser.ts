...
// @ts-ignore
  ...
  var peg$f0 = function(inputs, outputs) {
// @ts-ignore
...
// @ts-ignore
  ...
  var peg$f2 = function(name, optionalType, optionalDesc) {
// @ts-ignore
      return { 
// @ts-ignore
        name, 
...
export type ParseFunction = <Options extends ParseOptions>(
    ...
    StartRule extends "ParsedSignature" ? ParsedSignature : ParsedSignature
    : ParsedSignature;
