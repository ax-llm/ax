...
- Kind: `type`
- Form: `context.WithCancelCause(ctx)`
...
- Kind: `error`
- Form: `axllm.AxAIServiceAbortedError`
...
- Kind: `function`
- Form: `axllm.SetRateLimiter(limiter)`
- Returns: `void`
...
- Kind: `type`
- Form: `axllm.NewAxMCPWebSocketTransport(url, options)`
- Returns: `MCP transport`
