...
def _openai_build_chat_request_impl(request: AxChatRequest, options: Any, prompt_caching: bool, reasoning_content_mode: str, reasoning_details_mode: str) -> Any:
    ...
    is_astra = _core_string_starts_with(model, "gpt-6-astra")
    cache_model = _core_or(is_gpt_56, is_astra)
    cache_provider_and_model = _core_and(prompt_caching, cache_model)
...
def _openai_apply_model_config_impl(payload: Any, model_config: Any) -> None:
    ...
    if is_stream:
        ...
        pass
    configured_model = _core_get(payload, "model", "")
    astra = _core_string_starts_with(configured_model, "gpt-6-astra")
    if astra:
...
def openai_reasoning_effort(model: str, budget: Any) -> Any:
    ...
    is_astra = _core_string_starts_with(model, "gpt-6-astra")
    modern = _core_or(is_gpt56, is_astra)
...
def ai_merge_replay_metadata(previous: Any, incoming: Any) -> Any:
    ...
    fields.append("thought_blocks")
    fields.append("thoughtBlocks")
    for field in fields:
        old = _core_get(previous, field, empty)
        incoming_items = _core_get(incoming, field, empty)
        merged = []
        for item in old:
            merged.append(item)
        for item in incoming_items:
            id = _core_get(item, "id", None)
            has_id = _core_truthy(id)
            found = False
            updated = []
            for existing in merged:
                old_id = _core_get(existing, "id", None)
                same = _core_eq(id, old_id)
                same = _core_and(same, has_id)
                if same:
                    replacement = _core_map_merge(existing, item)
                    is_image = _core_eq(field, "images")
                    if is_image:
                        replacement = item
                    else:
                        pass
                    has_summary = _core_map_contains(item, "summary")
                    encrypted_snake = _core_map_contains(item, "encrypted_content")
                    encrypted_camel = _core_map_contains(item, "encryptedContent")
                    is_complete = _core_or(has_summary, encrypted_snake)
                    is_complete = _core_or(is_complete, encrypted_camel)
                    is_complete = _core_or(is_complete, is_image)
                    if is_complete:
                        pass
                    else:
                        old_data = _core_get(existing, "data", "")
                        new_data = _core_get(item, "data", "")
                        data = _core_string_format("{}{}", old_data, new_data)
            ...
            if found:
                ...
                updated.append(item)
            merged = updated
        has_items = _core_truthy(merged)
        if has_items:
            out[field] = merged
        else:
            pass
    results = _core_get(incoming, "results", None)
    has_results = _core_is_not_none(results)
    if has_results:
        old_results = _core_get(previous, "results", empty)
        merged_results = []
        for result in results:
            index = _core_get(result, "index", 0)
            updated_result = result
            for old_result in old_results:
                old_index = _core_get(old_result, "index", 0)
                same = _core_eq(index, old_index)
                if same:
                    updated_result = ai_merge_replay_metadata(old_result, result)
                else:
                    pass
...
def _provider_model_catalog_registry() -> Any:
    ...
    catalog = _core_json_parse("{\"all\":[{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"gemini-embedding-2\",\"defaultModel\":\"gemini-2.5-flash\",\"displayName\":\"Google Gemini\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-2.0-flash-thinking-exp-01-21\",\"promptTokenCostPer1M\":0,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-2.0-pro-exp-02-05\",\"promptTokenCostPer1M\":0,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-robotics-er-1.6-preview\",\"promptTokenCostPer1M\":0,\"provider\":\"google-gemini\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-embedding-001\",\"promptTokenCostPer1M\":0.15,\"provider\":\"google-gemini\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.5-flash-8b\",\"promptTokenCostPer1M\":0.0375,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"contextWindow\":8192,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gemini-embedding-2\",\"promptTokenCostPer1M\":0.2,\"provider\":\"google-gemini\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.5-flash\",\"promptTokenCostPer1M\":0.075,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.3,\"currency\":\"usd\",\"deprecatedOn\":\"2026-06-01\",\"isDefault\":false,\"isDeprecated\":true,\"name\":\"gemini-2.0-flash-lite\",\"promptTokenCostPer1M\":0.075,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.025,\"cacheWriteTokenCostPer1M\":0.1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"deprecatedOn\":\"2026-06-01\",\"isDefault\":false,\"isDeprecated\":true,\"name\":\"gemini-2.0-flash\",\"promptTokenCostPer1M\":0.1,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.01,\"cacheWriteTokenCostPer1M\":0.1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-2.5-flash-lite\",\"promptTokenCostPer1M\":0.1,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.01,\"cacheWriteTokenCostPer1M\":0.1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-flash-lite-latest\",\"promptTokenCostPer1M\":0.1,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.025,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":1.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.1-flash-lite\",\"promptTokenCostPer1M\":0.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.025,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3.1-flash-lite-preview\",\"promptTokenCostPer1M\":0.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.0-pro\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.134,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3-pro-image-preview\",\"promptTokenCostPer1M\":2,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"image\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":2.5,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gemini-2.5-flash\",\"promptTokenCostPer1M\":0.3,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":2.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.5-flash-lite\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.3,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":2.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-flash-latest\",\"promptTokenCostPer1M\":0.3,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.05,\"cacheWriteTokenCostPer1M\":0.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3-flash-preview\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3.1-flash-image-preview\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"image\"},{\"audio\":{\"input\":false,\"output\":true},\"capabilities\":{\"audioInput\":false,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3.1-flash-tts-preview\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"type\":\"audio\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"nano-banana-2\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.5-pro\",\"promptTokenCostPer1M\":1.25,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":7.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.6-flash\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":7.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.7-flash\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":7.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.8-flash\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":9,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.5-flash\",\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.125,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.25,\"longContextCompletionTokenCostPer1M\":15,\"longContextPromptTokenCostPer1M\":2.5,\"longContextThreshold\":200000,\"name\":\"gemini-2.5-pro\",\"promptTokenCostPer1M\":1.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.125,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.25,\"longContextCompletionTokenCostPer1M\":15,\"longContextPromptTokenCostPer1M\":2.5,\"longContextThreshold\":200000,\"name\":\"gemini-pro-latest\",\"promptTokenCostPer1M\":1.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":12,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.4,\"longContextCompletionTokenCostPer1M\":18,\"longContextPromptTokenCostPer1M\":4,\"longContextThreshold\":200000,\"name\":\"gemini-3.1-pro-preview\",\"promptTokenCostPer1M\":2,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"contextWindow\":131072,\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.1-flash-live-preview\",\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"contextWindow\":131072,\"isDefault\":false,\"maxTokens\":8192,\"name\":\"gemini-2.5-flash-native-audio-preview-12-2025\",\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"audio\"}],\"name\":\"google-gemini\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"displayName\":\"WebLLM\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":8192,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"gemma-2-2b-it-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":8192,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"gemma-2-9b-it-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"maxTokens\":4096,\"name\":\"Llama-3.1-70B-Instruct-q4f16_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Llama-3.1-8B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Llama-3.2-1B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":true,\"maxTokens\":2048,\"name\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Mistral-7B-Instruct-v0.3-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Phi-3.5-mini-instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Qwen2.5-0.5B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Qwen2.5-1.5B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Qwen2.5-3B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Qwen2.5-7B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"}],\"name\":\"webllm\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-3-small\",\"defaultModel\":\"gpt-5-mini\",\"displayName\":\"OpenAI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.02,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"text-embedding-3-small\",\"promptTokenCostPer1M\":0.02,\"provider\":\"openai\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"text-embedding-ada-002\",\"promptTokenCostPer1M\":0.1,\"provider\":\"openai\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.13,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"text-embedding-3-large\",\"promptTokenCostPer1M\":0.13,\"provider\":\"openai\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.05,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-nano\",\"promptTokenCostPer1M\":0.1,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4o-mini\",\"promptTokenCostPer1M\":0.15,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.02,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":1.2,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.04,\"longContextCompletionTokenCostPer1M\":1.8,\"longContextPromptTokenCostPer1M\":0.4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-luna\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-3.5-turbo\",\"promptTokenCostPer1M\":0.5,\"provider\":\"openai\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-mini\",\"promptTokenCostPer1M\":0.4,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gpt-5-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":4.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o1-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o4-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1\",\"promptTokenCostPer1M\":2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o3\",\"promptTokenCostPer1M\":2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-max\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4o\",\"promptTokenCostPer1M\":2.5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":12,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.4,\"longContextCompletionTokenCostPer1M\":18,\"longContextPromptTokenCostPer1M\":4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-terra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2.5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"chatgpt-4o-latest\",\"promptTokenCostPer1M\":5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"name\":\"gpt-5.5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"gpt-5.6\"],\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-sol\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":30,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4-turbo\",\"promptTokenCostPer1M\":10,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1,\"cacheWriteTokenCostPer1M\":12.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":50,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":2,\"longContextCacheWriteTokenCostPer1M\":25,\"longContextCompletionTokenCostPer1M\":75,\"longContextPromptTokenCostPer1M\":20,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-6-astra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":10,\"provider\":\"openai\",\"supported\":{\"structuredOutputModes\":[\"native\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o1\",\"promptTokenCostPer1M\":15,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4\",\"promptTokenCostPer1M\":30,\"provider\":\"openai\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":120,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":15,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":168,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":21,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":180,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"longContextCompletionTokenCostPer1M\":270,\"longContextPromptTokenCostPer1M\":60,\"longContextThreshold\":272000,\"name\":\"gpt-5.5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":30,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-audio\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-audio-mini\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-audio-1.5\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-1.5\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-2\",\"provider\":\"openai\",\"supported\":{\"thinkingBudget\":true},\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-whisper\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-translate\",\"provider\":\"openai\",\"type\":\"audio\"}],\"name\":\"openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"command-r-plus\",\"displayName\":\"Cohere\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-english-light-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-english-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-multilingual-light-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-multilingual-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"command-light\",\"promptTokenCostPer1M\":0.3,\"provider\":\"cohere\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"command\",\"promptTokenCostPer1M\":0.5,\"provider\":\"cohere\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"command-r\",\"promptTokenCostPer1M\":0.5,\"provider\":\"cohere\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"command-r-plus\",\"promptTokenCostPer1M\":3,\"provider\":\"cohere\",\"type\":\"text\"}],\"name\":\"cohere\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"mistral-small-latest\",\"displayName\":\"Mistral AI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.15,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"mistral-nemo-latest\",\"promptTokenCostPer1M\":0.15,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-codestral-mamba\",\"promptTokenCostPer1M\":0.25,\"provider\":\"mistral\",\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-mistral-7b\",\"promptTokenCostPer1M\":0.25,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.3,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-mistral-nemo-latest\",\"promptTokenCostPer1M\":0.3,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"codestral-latest\",\"promptTokenCostPer1M\":0.2,\"provider\":\"mistral\",\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"USD\",\"isDefault\":true,\"name\":\"mistral-small-latest\",\"promptTokenCostPer1M\":0.2,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.7,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-mixtral-8x7b\",\"promptTokenCostPer1M\":0.7,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":6,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"mistral-large-latest\",\"promptTokenCostPer1M\":2,\"provider\":\"mistral\",\"type\":\"text\"}],\"name\":\"mistral\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek\",\"isDynamic\":false,\"models\":[{\"aliases\":[\"deepseek-chat\",\"deepseek-reasoner\"],\"cacheReadTokenCostPer1M\":0.0028,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.28,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":true,\"maxTokens\":384000,\"name\":\"deepseek-v4-flash\",\"promptTokenCostPer1M\":0.14,\"provider\":\"deepseek\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.003625,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.87,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":false,\"maxTokens\":384000,\"name\":\"deepseek-v4-pro\",\"promptTokenCostPer1M\":0.435,\"provider\":\"deepseek\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"deepseek\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek Responses\",\"isDynamic\":false,\"models\":[{\"aliases\":[\"deepseek-chat\",\"deepseek-reasoner\"],\"cacheReadTokenCostPer1M\":0.0028,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.28,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":true,\"maxTokens\":384000,\"name\":\"deepseek-v4-flash\",\"promptTokenCostPer1M\":0.14,\"provider\":\"deepseek-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.003625,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.87,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":false,\"maxTokens\":384000,\"name\":\"deepseek-v4-pro\",\"promptTokenCostPer1M\":0.435,\"provider\":\"deepseek-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"deepseek-responses\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-ada-002\",\"defaultModel\":\"gpt-4o\",\"displayName\":\"OpenAI Responses\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.05,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-nano\",\"promptTokenCostPer1M\":0.1,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4o-mini\",\"promptTokenCostPer1M\":0.15,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.02,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":1.2,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.04,\"longContextCompletionTokenCostPer1M\":1.8,\"longContextPromptTokenCostPer1M\":0.4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-luna\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-3.5-turbo\",\"promptTokenCostPer1M\":0.5,\"provider\":\"openai-responses\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-mini\",\"promptTokenCostPer1M\":0.4,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":4.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o3-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o4-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1\",\"promptTokenCostPer1M\":2,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o3\",\"promptTokenCostPer1M\":2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-max\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gpt-4o\",\"promptTokenCostPer1M\":2.5,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":12,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.4,\"longContextCompletionTokenCostPer1M\":18,\"longContextPromptTokenCostPer1M\":4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-terra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2.5,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"chatgpt-4o-latest\",\"promptTokenCostPer1M\":5,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"name\":\"gpt-5.5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"gpt-5.6\"],\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-sol\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":30,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4-turbo\",\"promptTokenCostPer1M\":10,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1,\"cacheWriteTokenCostPer1M\":12.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":50,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":2,\"longContextCacheWriteTokenCostPer1M\":25,\"longContextCompletionTokenCostPer1M\":75,\"longContextPromptTokenCostPer1M\":20,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-6-astra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":10,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o1\",\"promptTokenCostPer1M\":15,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4\",\"promptTokenCostPer1M\":30,\"provider\":\"openai-responses\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":80,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"name\":\"o3-pro\",\"promptTokenCostPer1M\":20,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":120,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":15,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":168,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":21,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":180,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"longContextCompletionTokenCostPer1M\":270,\"longContextPromptTokenCostPer1M\":60,\"longContextThreshold\":272000,\"name\":\"gpt-5.5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":30,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":600,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"name\":\"o1-pro\",\"promptTokenCostPer1M\":150,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"openai-responses\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"grok-4.6\",\"displayName\":\"xAI Grok\",\"isDynamic\":false,\"models\":[{\"aliases\":[\"grok-4-1-fast-non-reasoning-latest\"],\"cacheReadTokenCostPer1M\":0.05,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4-1-fast-non-reasoning\",\"promptTokenCostPer1M\":0.2,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4-1-fast-reasoning-latest\"],\"cacheReadTokenCostPer1M\":0.05,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4-1-fast-reasoning\",\"promptTokenCostPer1M\":0.2,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.5,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3-mini\",\"promptTokenCostPer1M\":0.3,\"provider\":\"grok\",\"supported\":{\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.20-multi-agent-0309\",\"grok-4.20-multi-agent-latest\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.20-multi-agent\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.20-0309-non-reasoning\",\"grok-4.20-non-reasoning-latest\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.20-non-reasoning\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.20-0309-reasoning\",\"grok-4.20-reasoning-latest\",\"grok-4.20\",\"grok-4.20-0309\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.20-reasoning\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.3-latest\",\"grok-latest\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.3\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":4,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3-mini-fast\",\"promptTokenCostPer1M\":0.6,\"provider\":\"grok\",\"supported\":{\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.5-latest\",\"grok-build-latest\"],\"cacheReadTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":6,\"contextWindow\":500000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.5\",\"promptTokenCostPer1M\":2,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3\",\"promptTokenCostPer1M\":3,\"provider\":\"grok\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3-fast\",\"promptTokenCostPer1M\":5,\"provider\":\"grok\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"currency\":\"USD\",\"isDefault\":true,\"name\":\"grok-4.6\",\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-voice-think-fast-1.0\",\"provider\":\"grok\",\"type\":\"audio\"},{\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-voice-fast-1.0\",\"provider\":\"grok\",\"type\":\"audio\"}],\"name\":\"grok\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"reka-core\",\"displayName\":\"Reka\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"reka-edge\",\"promptTokenCostPer1M\":0.4,\"provider\":\"reka\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"reka-flash\",\"promptTokenCostPer1M\":0.8,\"provider\":\"reka\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"reka-core\",\"promptTokenCostPer1M\":3,\"provider\":\"reka\",\"type\":\"text\"}],\"name\":\"reka\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"claude-3-7-sonnet-latest\",\"displayName\":\"Anthropic\",\"isDynamic\":false,\"models\":[{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-haiku-20240307\",\"promptTokenCostPer1M\":0.25,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-haiku@20240307\",\"promptTokenCostPer1M\":0.25,\"provider\":\"anthropic\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.24,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-instant-1.2\",\"promptTokenCostPer1M\":0.8,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.08,\"cacheWriteTokenCostPer1M\":1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":4,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-haiku-latest\",\"promptTokenCostPer1M\":0.8,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.1,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-haiku@20241022\",\"promptTokenCostPer1M\":1,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.1,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-haiku-4-5\",\"promptTokenCostPer1M\":1,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.1,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-haiku-4-5@20251001\",\"promptTokenCostPer1M\":1,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":10,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-sonnet-5\",\"promptTokenCostPer1M\":2,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":10,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-sonnet-5\",\"promptTokenCostPer1M\":2,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-sonnet-latest\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-sonnet-v2@20241022\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-sonnet@20240620\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":true,\"maxTokens\":64000,\"name\":\"claude-3-7-sonnet-latest\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-3-7-sonnet@20250219\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-sonnet-20240229\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4-20250514\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-sonnet-4-5-20250929\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-sonnet-4-5@20250929\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4-6\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4-6\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4@20250514\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-opus-4-5-20251101\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-opus-4-5@20251101\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"fastCacheReadTokenCostPer1M\":3,\"fastCacheWriteTokenCostPer1M\":37.5,\"fastCompletionTokenCostPer1M\":150,\"fastPromptTokenCostPer1M\":30,\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-6\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-6\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"fastCacheReadTokenCostPer1M\":3,\"fastCacheWriteTokenCostPer1M\":37.5,\"fastCompletionTokenCostPer1M\":150,\"fastPromptTokenCostPer1M\":30,\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-7\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-7\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"fastCacheReadTokenCostPer1M\":1,\"fastCacheWriteTokenCostPer1M\":12.5,\"fastCompletionTokenCostPer1M\":50,\"fastPromptTokenCostPer1M\":10,\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-8\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-8\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-2.1\",\"promptTokenCostPer1M\":8,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-opus-latest\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-opus@20240229\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4-1-20250805\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4-1@20250805\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4-20250514\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4@20250514\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"anthropic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenAI Compatible\",\"isDynamic\":true,\"models\":[],\"name\":\"openai-compatible\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"displayName\":\"Azure OpenAI\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":true,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3-contributor\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2-contributor\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.1\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":true,\"pdfInput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":false,\"textInput\":true,\"textOutput\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false,\"videoInput\":false},\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\"],\"output\":[\"image\"]},\"name\":\"muse-image-1.0\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"provider\":\"meta\",\"supported\":{\"imageOutput\":true,\"operations\":[\"chat\"]},\"type\":\"image\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":false,\"imageOutput\":false,\"pdfInput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":false,\"textInput\":false,\"textOutput\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false,\"videoInput\":false},\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"audio\"],\"output\":[\"text\"]},\"name\":\"muse-voice-transcribe-1.0\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\",\"transcribe\"]},\"type\":\"audio\"}],\"name\":\"meta\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Chat Completions\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":true,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3-contributor\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2-contributor\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.1\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"meta-chat\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Messages\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":true,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3-contributor\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2-contributor\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.1\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"meta-messages\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Together AI\",\"isDynamic\":true,\"models\":[],\"name\":\"together\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"openrouter\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OrcaRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"orcarouter\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Fireworks AI\",\"isDynamic\":true,\"models\":[],\"name\":\"fireworks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hugging Face Router\",\"isDynamic\":true,\"models\":[],\"name\":\"huggingface-router\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Amazon Bedrock\",\"isDynamic\":true,\"models\":[],\"name\":\"amazon-bedrock\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Azure AI Foundry\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-foundry\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Vertex AI OpenAI Compatibility\",\"isDynamic\":true,\"models\":[],\"name\":\"vertex-ai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Databricks Model Serving\",\"isDynamic\":true,\"models\":[],\"name\":\"databricks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Model APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Groq\",\"isDynamic\":true,\"models\":[],\"name\":\"groq\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cerebras Inference\",\"isDynamic\":true,\"models\":[],\"name\":\"cerebras\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"DeepInfra\",\"isDynamic\":true,\"models\":[],\"name\":\"deepinfra\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SambaNova Cloud\",\"isDynamic\":true,\"models\":[],\"name\":\"sambanova\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nebius AI Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"nebius\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Novita AI\",\"isDynamic\":true,\"models\":[],\"name\":\"novita\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hyperbolic\",\"isDynamic\":true,\"models\":[],\"name\":\"hyperbolic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SiliconFlow\",\"isDynamic\":true,\"models\":[],\"name\":\"siliconflow\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"FriendliAI\",\"isDynamic\":true,\"models\":[],\"name\":\"friendli\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cloudflare Workers AI\",\"isDynamic\":true,\"models\":[],\"name\":\"cloudflare-workers-ai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Featherless AI\",\"isDynamic\":true,\"models\":[],\"name\":\"featherless\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nscale\",\"isDynamic\":true,\"models\":[],\"name\":\"nscale\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OVHcloud AI Endpoints\",\"isDynamic\":true,\"models\":[],\"name\":\"ovhcloud\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Scaleway Generative APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"scaleway\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"NVIDIA NIM\",\"isDynamic\":true,\"models\":[],\"name\":\"nvidia-nim\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"RunPod vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"runpod-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SageMaker vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"sagemaker-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Ollama\",\"isDynamic\":true,\"models\":[],\"name\":\"ollama\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LM Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"lm-studio\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"llama.cpp Server\",\"isDynamic\":true,\"models\":[],\"name\":\"llama-cpp\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LocalAI\",\"isDynamic\":true,\"models\":[],\"name\":\"localai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Inference Engine\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten-engine\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Typesafe\",\"isDynamic\":true,\"models\":[],\"name\":\"typesafe\"}],\"audio\":[{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"gemini-embedding-2\",\"defaultModel\":\"gemini-2.5-flash\",\"displayName\":\"Google Gemini\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":false,\"output\":true},\"capabilities\":{\"audioInput\":false,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3.1-flash-tts-preview\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"contextWindow\":131072,\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.1-flash-live-preview\",\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"contextWindow\":131072,\"isDefault\":false,\"maxTokens\":8192,\"name\":\"gemini-2.5-flash-native-audio-preview-12-2025\",\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"audio\"}],\"name\":\"google-gemini\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-3-small\",\"defaultModel\":\"gpt-5-mini\",\"displayName\":\"OpenAI\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-audio\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-audio-mini\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-audio-1.5\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-1.5\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-2\",\"provider\":\"openai\",\"supported\":{\"thinkingBudget\":true},\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-whisper\",\"provider\":\"openai\",\"type\":\"audio\"},{\"audio\":{\"input\":true,\"output\":true},\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"isDefault\":false,\"name\":\"gpt-realtime-translate\",\"provider\":\"openai\",\"type\":\"audio\"}],\"name\":\"openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenAI Compatible\",\"isDynamic\":true,\"models\":[],\"name\":\"openai-compatible\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-ada-002\",\"defaultModel\":\"gpt-4o\",\"displayName\":\"OpenAI Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"openai-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"claude-3-7-sonnet-latest\",\"displayName\":\"Anthropic\",\"isDynamic\":false,\"models\":[],\"name\":\"anthropic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"displayName\":\"WebLLM\",\"isDynamic\":false,\"models\":[],\"name\":\"webllm\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"displayName\":\"Azure OpenAI\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":false,\"imageOutput\":false,\"pdfInput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":false,\"textInput\":false,\"textOutput\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false,\"videoInput\":false},\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"audio\"],\"output\":[\"text\"]},\"name\":\"muse-voice-transcribe-1.0\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\",\"transcribe\"]},\"type\":\"audio\"}],\"name\":\"meta\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Chat Completions\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-chat\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Messages\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-messages\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"mistral-small-latest\",\"displayName\":\"Mistral AI\",\"isDynamic\":false,\"models\":[],\"name\":\"mistral\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"command-r-plus\",\"displayName\":\"Cohere\",\"isDynamic\":false,\"models\":[],\"name\":\"cohere\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"grok-4.6\",\"displayName\":\"xAI Grok\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-voice-think-fast-1.0\",\"provider\":\"grok\",\"type\":\"audio\"},{\"capabilities\":{\"audioInput\":true,\"audioOutput\":true,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-voice-fast-1.0\",\"provider\":\"grok\",\"type\":\"audio\"}],\"name\":\"grok\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"reka-core\",\"displayName\":\"Reka\",\"isDynamic\":false,\"models\":[],\"name\":\"reka\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Together AI\",\"isDynamic\":true,\"models\":[],\"name\":\"together\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"openrouter\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OrcaRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"orcarouter\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Fireworks AI\",\"isDynamic\":true,\"models\":[],\"name\":\"fireworks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hugging Face Router\",\"isDynamic\":true,\"models\":[],\"name\":\"huggingface-router\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Amazon Bedrock\",\"isDynamic\":true,\"models\":[],\"name\":\"amazon-bedrock\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Azure AI Foundry\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-foundry\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Vertex AI OpenAI Compatibility\",\"isDynamic\":true,\"models\":[],\"name\":\"vertex-ai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Databricks Model Serving\",\"isDynamic\":true,\"models\":[],\"name\":\"databricks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Model APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Groq\",\"isDynamic\":true,\"models\":[],\"name\":\"groq\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cerebras Inference\",\"isDynamic\":true,\"models\":[],\"name\":\"cerebras\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"DeepInfra\",\"isDynamic\":true,\"models\":[],\"name\":\"deepinfra\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SambaNova Cloud\",\"isDynamic\":true,\"models\":[],\"name\":\"sambanova\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nebius AI Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"nebius\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Novita AI\",\"isDynamic\":true,\"models\":[],\"name\":\"novita\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hyperbolic\",\"isDynamic\":true,\"models\":[],\"name\":\"hyperbolic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SiliconFlow\",\"isDynamic\":true,\"models\":[],\"name\":\"siliconflow\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"FriendliAI\",\"isDynamic\":true,\"models\":[],\"name\":\"friendli\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cloudflare Workers AI\",\"isDynamic\":true,\"models\":[],\"name\":\"cloudflare-workers-ai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Featherless AI\",\"isDynamic\":true,\"models\":[],\"name\":\"featherless\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nscale\",\"isDynamic\":true,\"models\":[],\"name\":\"nscale\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OVHcloud AI Endpoints\",\"isDynamic\":true,\"models\":[],\"name\":\"ovhcloud\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Scaleway Generative APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"scaleway\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"NVIDIA NIM\",\"isDynamic\":true,\"models\":[],\"name\":\"nvidia-nim\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"RunPod vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"runpod-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SageMaker vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"sagemaker-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Ollama\",\"isDynamic\":true,\"models\":[],\"name\":\"ollama\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LM Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"lm-studio\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"llama.cpp Server\",\"isDynamic\":true,\"models\":[],\"name\":\"llama-cpp\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LocalAI\",\"isDynamic\":true,\"models\":[],\"name\":\"localai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Inference Engine\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten-engine\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Typesafe\",\"isDynamic\":true,\"models\":[],\"name\":\"typesafe\"}],\"code\":[{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"mistral-small-latest\",\"displayName\":\"Mistral AI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-codestral-mamba\",\"promptTokenCostPer1M\":0.25,\"provider\":\"mistral\",\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"codestral-latest\",\"promptTokenCostPer1M\":0.2,\"provider\":\"mistral\",\"type\":\"code\"}],\"name\":\"mistral\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-3-small\",\"defaultModel\":\"gpt-5-mini\",\"displayName\":\"OpenAI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-max\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"}],\"name\":\"openai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-ada-002\",\"defaultModel\":\"gpt-4o\",\"displayName\":\"OpenAI Responses\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-max\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"}],\"name\":\"openai-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenAI Compatible\",\"isDynamic\":true,\"models\":[],\"name\":\"openai-compatible\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"claude-3-7-sonnet-latest\",\"displayName\":\"Anthropic\",\"isDynamic\":false,\"models\":[],\"name\":\"anthropic\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"gemini-embedding-2\",\"defaultModel\":\"gemini-2.5-flash\",\"displayName\":\"Google Gemini\",\"isDynamic\":false,\"models\":[],\"name\":\"google-gemini\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"displayName\":\"WebLLM\",\"isDynamic\":false,\"models\":[],\"name\":\"webllm\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"displayName\":\"Azure OpenAI\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API\",\"isDynamic\":false,\"models\":[],\"name\":\"meta\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Chat Completions\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-chat\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Messages\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-messages\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"command-r-plus\",\"displayName\":\"Cohere\",\"isDynamic\":false,\"models\":[],\"name\":\"cohere\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"grok-4.6\",\"displayName\":\"xAI Grok\",\"isDynamic\":false,\"models\":[],\"name\":\"grok\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"reka-core\",\"displayName\":\"Reka\",\"isDynamic\":false,\"models\":[],\"name\":\"reka\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Together AI\",\"isDynamic\":true,\"models\":[],\"name\":\"together\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"openrouter\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OrcaRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"orcarouter\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Fireworks AI\",\"isDynamic\":true,\"models\":[],\"name\":\"fireworks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hugging Face Router\",\"isDynamic\":true,\"models\":[],\"name\":\"huggingface-router\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Amazon Bedrock\",\"isDynamic\":true,\"models\":[],\"name\":\"amazon-bedrock\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Azure AI Foundry\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-foundry\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Vertex AI OpenAI Compatibility\",\"isDynamic\":true,\"models\":[],\"name\":\"vertex-ai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Databricks Model Serving\",\"isDynamic\":true,\"models\":[],\"name\":\"databricks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Model APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Groq\",\"isDynamic\":true,\"models\":[],\"name\":\"groq\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cerebras Inference\",\"isDynamic\":true,\"models\":[],\"name\":\"cerebras\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"DeepInfra\",\"isDynamic\":true,\"models\":[],\"name\":\"deepinfra\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SambaNova Cloud\",\"isDynamic\":true,\"models\":[],\"name\":\"sambanova\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nebius AI Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"nebius\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Novita AI\",\"isDynamic\":true,\"models\":[],\"name\":\"novita\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hyperbolic\",\"isDynamic\":true,\"models\":[],\"name\":\"hyperbolic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SiliconFlow\",\"isDynamic\":true,\"models\":[],\"name\":\"siliconflow\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"FriendliAI\",\"isDynamic\":true,\"models\":[],\"name\":\"friendli\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cloudflare Workers AI\",\"isDynamic\":true,\"models\":[],\"name\":\"cloudflare-workers-ai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Featherless AI\",\"isDynamic\":true,\"models\":[],\"name\":\"featherless\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nscale\",\"isDynamic\":true,\"models\":[],\"name\":\"nscale\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OVHcloud AI Endpoints\",\"isDynamic\":true,\"models\":[],\"name\":\"ovhcloud\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Scaleway Generative APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"scaleway\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"NVIDIA NIM\",\"isDynamic\":true,\"models\":[],\"name\":\"nvidia-nim\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"RunPod vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"runpod-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SageMaker vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"sagemaker-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Ollama\",\"isDynamic\":true,\"models\":[],\"name\":\"ollama\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LM Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"lm-studio\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"llama.cpp Server\",\"isDynamic\":true,\"models\":[],\"name\":\"llama-cpp\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LocalAI\",\"isDynamic\":true,\"models\":[],\"name\":\"localai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Inference Engine\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten-engine\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Typesafe\",\"isDynamic\":true,\"models\":[],\"name\":\"typesafe\"}],\"embeddings\":[{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-3-small\",\"defaultModel\":\"gpt-5-mini\",\"displayName\":\"OpenAI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.02,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"text-embedding-3-small\",\"promptTokenCostPer1M\":0.02,\"provider\":\"openai\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"text-embedding-ada-002\",\"promptTokenCostPer1M\":0.1,\"provider\":\"openai\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.13,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"text-embedding-3-large\",\"promptTokenCostPer1M\":0.13,\"provider\":\"openai\",\"type\":\"embeddings\"}],\"name\":\"openai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"gemini-embedding-2\",\"defaultModel\":\"gemini-2.5-flash\",\"displayName\":\"Google Gemini\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-embedding-001\",\"promptTokenCostPer1M\":0.15,\"provider\":\"google-gemini\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"contextWindow\":8192,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gemini-embedding-2\",\"promptTokenCostPer1M\":0.2,\"provider\":\"google-gemini\",\"type\":\"embeddings\"}],\"name\":\"google-gemini\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"command-r-plus\",\"displayName\":\"Cohere\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-english-light-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-english-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-multilingual-light-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"embed-multilingual-v3.0\",\"promptTokenCostPer1M\":0.1,\"provider\":\"cohere\",\"type\":\"embeddings\"}],\"name\":\"cohere\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenAI Compatible\",\"isDynamic\":true,\"models\":[],\"name\":\"openai-compatible\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-ada-002\",\"defaultModel\":\"gpt-4o\",\"displayName\":\"OpenAI Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"openai-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"claude-3-7-sonnet-latest\",\"displayName\":\"Anthropic\",\"isDynamic\":false,\"models\":[],\"name\":\"anthropic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"displayName\":\"WebLLM\",\"isDynamic\":false,\"models\":[],\"name\":\"webllm\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"displayName\":\"Azure OpenAI\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API\",\"isDynamic\":false,\"models\":[],\"name\":\"meta\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Chat Completions\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-chat\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Messages\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-messages\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"mistral-small-latest\",\"displayName\":\"Mistral AI\",\"isDynamic\":false,\"models\":[],\"name\":\"mistral\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"grok-4.6\",\"displayName\":\"xAI Grok\",\"isDynamic\":false,\"models\":[],\"name\":\"grok\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"reka-core\",\"displayName\":\"Reka\",\"isDynamic\":false,\"models\":[],\"name\":\"reka\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Together AI\",\"isDynamic\":true,\"models\":[],\"name\":\"together\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"openrouter\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OrcaRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"orcarouter\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Fireworks AI\",\"isDynamic\":true,\"models\":[],\"name\":\"fireworks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hugging Face Router\",\"isDynamic\":true,\"models\":[],\"name\":\"huggingface-router\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Amazon Bedrock\",\"isDynamic\":true,\"models\":[],\"name\":\"amazon-bedrock\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Azure AI Foundry\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-foundry\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Vertex AI OpenAI Compatibility\",\"isDynamic\":true,\"models\":[],\"name\":\"vertex-ai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Databricks Model Serving\",\"isDynamic\":true,\"models\":[],\"name\":\"databricks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Model APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Groq\",\"isDynamic\":true,\"models\":[],\"name\":\"groq\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cerebras Inference\",\"isDynamic\":true,\"models\":[],\"name\":\"cerebras\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"DeepInfra\",\"isDynamic\":true,\"models\":[],\"name\":\"deepinfra\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SambaNova Cloud\",\"isDynamic\":true,\"models\":[],\"name\":\"sambanova\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nebius AI Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"nebius\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Novita AI\",\"isDynamic\":true,\"models\":[],\"name\":\"novita\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hyperbolic\",\"isDynamic\":true,\"models\":[],\"name\":\"hyperbolic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SiliconFlow\",\"isDynamic\":true,\"models\":[],\"name\":\"siliconflow\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"FriendliAI\",\"isDynamic\":true,\"models\":[],\"name\":\"friendli\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cloudflare Workers AI\",\"isDynamic\":true,\"models\":[],\"name\":\"cloudflare-workers-ai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Featherless AI\",\"isDynamic\":true,\"models\":[],\"name\":\"featherless\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nscale\",\"isDynamic\":true,\"models\":[],\"name\":\"nscale\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OVHcloud AI Endpoints\",\"isDynamic\":true,\"models\":[],\"name\":\"ovhcloud\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Scaleway Generative APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"scaleway\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"NVIDIA NIM\",\"isDynamic\":true,\"models\":[],\"name\":\"nvidia-nim\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"RunPod vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"runpod-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SageMaker vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"sagemaker-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Ollama\",\"isDynamic\":true,\"models\":[],\"name\":\"ollama\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LM Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"lm-studio\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"llama.cpp Server\",\"isDynamic\":true,\"models\":[],\"name\":\"llama-cpp\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LocalAI\",\"isDynamic\":true,\"models\":[],\"name\":\"localai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Inference Engine\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten-engine\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Typesafe\",\"isDynamic\":true,\"models\":[],\"name\":\"typesafe\"}],\"image\":[{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"gemini-embedding-2\",\"defaultModel\":\"gemini-2.5-flash\",\"displayName\":\"Google Gemini\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.134,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3-pro-image-preview\",\"promptTokenCostPer1M\":2,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"image\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3.1-flash-image-preview\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"image\"}],\"name\":\"google-gemini\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-3-small\",\"defaultModel\":\"gpt-5-mini\",\"displayName\":\"OpenAI\",\"isDynamic\":false,\"models\":[],\"name\":\"openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenAI Compatible\",\"isDynamic\":true,\"models\":[],\"name\":\"openai-compatible\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-ada-002\",\"defaultModel\":\"gpt-4o\",\"displayName\":\"OpenAI Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"openai-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"claude-3-7-sonnet-latest\",\"displayName\":\"Anthropic\",\"isDynamic\":false,\"models\":[],\"name\":\"anthropic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"displayName\":\"WebLLM\",\"isDynamic\":false,\"models\":[],\"name\":\"webllm\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"displayName\":\"Azure OpenAI\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek Responses\",\"isDynamic\":false,\"models\":[],\"name\":\"deepseek-responses\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":true,\"pdfInput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":false,\"textInput\":true,\"textOutput\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false,\"videoInput\":false},\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\"],\"output\":[\"image\"]},\"name\":\"muse-image-1.0\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"provider\":\"meta\",\"supported\":{\"imageOutput\":true,\"operations\":[\"chat\"]},\"type\":\"image\"}],\"name\":\"meta\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Chat Completions\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-chat\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Messages\",\"isDynamic\":false,\"models\":[],\"name\":\"meta-messages\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"mistral-small-latest\",\"displayName\":\"Mistral AI\",\"isDynamic\":false,\"models\":[],\"name\":\"mistral\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"command-r-plus\",\"displayName\":\"Cohere\",\"isDynamic\":false,\"models\":[],\"name\":\"cohere\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"grok-4.6\",\"displayName\":\"xAI Grok\",\"isDynamic\":false,\"models\":[],\"name\":\"grok\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"reka-core\",\"displayName\":\"Reka\",\"isDynamic\":false,\"models\":[],\"name\":\"reka\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Together AI\",\"isDynamic\":true,\"models\":[],\"name\":\"together\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"openrouter\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OrcaRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"orcarouter\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Fireworks AI\",\"isDynamic\":true,\"models\":[],\"name\":\"fireworks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hugging Face Router\",\"isDynamic\":true,\"models\":[],\"name\":\"huggingface-router\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Amazon Bedrock\",\"isDynamic\":true,\"models\":[],\"name\":\"amazon-bedrock\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Azure AI Foundry\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-foundry\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Vertex AI OpenAI Compatibility\",\"isDynamic\":true,\"models\":[],\"name\":\"vertex-ai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Databricks Model Serving\",\"isDynamic\":true,\"models\":[],\"name\":\"databricks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Model APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Groq\",\"isDynamic\":true,\"models\":[],\"name\":\"groq\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cerebras Inference\",\"isDynamic\":true,\"models\":[],\"name\":\"cerebras\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"DeepInfra\",\"isDynamic\":true,\"models\":[],\"name\":\"deepinfra\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SambaNova Cloud\",\"isDynamic\":true,\"models\":[],\"name\":\"sambanova\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nebius AI Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"nebius\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Novita AI\",\"isDynamic\":true,\"models\":[],\"name\":\"novita\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hyperbolic\",\"isDynamic\":true,\"models\":[],\"name\":\"hyperbolic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SiliconFlow\",\"isDynamic\":true,\"models\":[],\"name\":\"siliconflow\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"FriendliAI\",\"isDynamic\":true,\"models\":[],\"name\":\"friendli\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cloudflare Workers AI\",\"isDynamic\":true,\"models\":[],\"name\":\"cloudflare-workers-ai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Featherless AI\",\"isDynamic\":true,\"models\":[],\"name\":\"featherless\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nscale\",\"isDynamic\":true,\"models\":[],\"name\":\"nscale\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OVHcloud AI Endpoints\",\"isDynamic\":true,\"models\":[],\"name\":\"ovhcloud\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Scaleway Generative APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"scaleway\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"NVIDIA NIM\",\"isDynamic\":true,\"models\":[],\"name\":\"nvidia-nim\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"RunPod vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"runpod-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SageMaker vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"sagemaker-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Ollama\",\"isDynamic\":true,\"models\":[],\"name\":\"ollama\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LM Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"lm-studio\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"llama.cpp Server\",\"isDynamic\":true,\"models\":[],\"name\":\"llama-cpp\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LocalAI\",\"isDynamic\":true,\"models\":[],\"name\":\"localai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Inference Engine\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten-engine\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Typesafe\",\"isDynamic\":true,\"models\":[],\"name\":\"typesafe\"}],\"text\":[{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"gemini-embedding-2\",\"defaultModel\":\"gemini-2.5-flash\",\"displayName\":\"Google Gemini\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-2.0-flash-thinking-exp-01-21\",\"promptTokenCostPer1M\":0,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-2.0-pro-exp-02-05\",\"promptTokenCostPer1M\":0,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-robotics-er-1.6-preview\",\"promptTokenCostPer1M\":0,\"provider\":\"google-gemini\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.5-flash-8b\",\"promptTokenCostPer1M\":0.0375,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.5-flash\",\"promptTokenCostPer1M\":0.075,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.3,\"currency\":\"usd\",\"deprecatedOn\":\"2026-06-01\",\"isDefault\":false,\"isDeprecated\":true,\"name\":\"gemini-2.0-flash-lite\",\"promptTokenCostPer1M\":0.075,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.025,\"cacheWriteTokenCostPer1M\":0.1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"deprecatedOn\":\"2026-06-01\",\"isDefault\":false,\"isDeprecated\":true,\"name\":\"gemini-2.0-flash\",\"promptTokenCostPer1M\":0.1,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.01,\"cacheWriteTokenCostPer1M\":0.1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-2.5-flash-lite\",\"promptTokenCostPer1M\":0.1,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.01,\"cacheWriteTokenCostPer1M\":0.1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-flash-lite-latest\",\"promptTokenCostPer1M\":0.1,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.025,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":1.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.1-flash-lite\",\"promptTokenCostPer1M\":0.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.025,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3.1-flash-lite-preview\",\"promptTokenCostPer1M\":0.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.0-pro\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":2.5,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gemini-2.5-flash\",\"promptTokenCostPer1M\":0.3,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":2.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.5-flash-lite\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.3,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":2.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-flash-latest\",\"promptTokenCostPer1M\":0.3,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.05,\"cacheWriteTokenCostPer1M\":0.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-3-flash-preview\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":3,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"nano-banana-2\",\"promptTokenCostPer1M\":0.5,\"provider\":\"google-gemini\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gemini-1.5-pro\",\"promptTokenCostPer1M\":1.25,\"provider\":\"google-gemini\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":7.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.6-flash\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":7.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.7-flash\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"characterIsToken\":false,\"completionTokenCostPer1M\":7.5,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.8-flash\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.15,\"cacheWriteTokenCostPer1M\":1.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":9,\"contextWindow\":1048576,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":65536,\"name\":\"gemini-3.5-flash\",\"promptTokenCostPer1M\":1.5,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.125,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.25,\"longContextCompletionTokenCostPer1M\":15,\"longContextPromptTokenCostPer1M\":2.5,\"longContextThreshold\":200000,\"name\":\"gemini-2.5-pro\",\"promptTokenCostPer1M\":1.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.125,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.25,\"longContextCompletionTokenCostPer1M\":15,\"longContextPromptTokenCostPer1M\":2.5,\"longContextThreshold\":200000,\"name\":\"gemini-pro-latest\",\"promptTokenCostPer1M\":1.25,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"characterIsToken\":false,\"completionTokenCostPer1M\":12,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.4,\"longContextCompletionTokenCostPer1M\":18,\"longContextPromptTokenCostPer1M\":4,\"longContextThreshold\":200000,\"name\":\"gemini-3.1-pro-preview\",\"promptTokenCostPer1M\":2,\"provider\":\"google-gemini\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"google-gemini\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"displayName\":\"WebLLM\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":8192,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"gemma-2-2b-it-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":8192,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"gemma-2-9b-it-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"maxTokens\":4096,\"name\":\"Llama-3.1-70B-Instruct-q4f16_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Llama-3.1-8B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Llama-3.2-1B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":true,\"maxTokens\":2048,\"name\":\"Llama-3.2-3B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Mistral-7B-Instruct-v0.3-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":128000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Phi-3.5-mini-instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Qwen2.5-0.5B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Qwen2.5-1.5B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":2048,\"name\":\"Qwen2.5-3B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0,\"contextWindow\":32768,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"Qwen2.5-7B-Instruct-q4f32_1-MLC\",\"promptTokenCostPer1M\":0,\"provider\":\"webllm\",\"type\":\"text\"}],\"name\":\"webllm\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"mistral-small-latest\",\"displayName\":\"Mistral AI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.15,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"mistral-nemo-latest\",\"promptTokenCostPer1M\":0.15,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-codestral-mamba\",\"promptTokenCostPer1M\":0.25,\"provider\":\"mistral\",\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-mistral-7b\",\"promptTokenCostPer1M\":0.25,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.3,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-mistral-nemo-latest\",\"promptTokenCostPer1M\":0.3,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"codestral-latest\",\"promptTokenCostPer1M\":0.2,\"provider\":\"mistral\",\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"USD\",\"isDefault\":true,\"name\":\"mistral-small-latest\",\"promptTokenCostPer1M\":0.2,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.7,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"open-mixtral-8x7b\",\"promptTokenCostPer1M\":0.7,\"provider\":\"mistral\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":6,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"mistral-large-latest\",\"promptTokenCostPer1M\":2,\"provider\":\"mistral\",\"type\":\"text\"}],\"name\":\"mistral\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek\",\"isDynamic\":false,\"models\":[{\"aliases\":[\"deepseek-chat\",\"deepseek-reasoner\"],\"cacheReadTokenCostPer1M\":0.0028,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.28,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":true,\"maxTokens\":384000,\"name\":\"deepseek-v4-flash\",\"promptTokenCostPer1M\":0.14,\"provider\":\"deepseek\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.003625,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.87,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":false,\"maxTokens\":384000,\"name\":\"deepseek-v4-pro\",\"promptTokenCostPer1M\":0.435,\"provider\":\"deepseek\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"deepseek\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"deepseek-v4-flash\",\"displayName\":\"DeepSeek Responses\",\"isDynamic\":false,\"models\":[{\"aliases\":[\"deepseek-chat\",\"deepseek-reasoner\"],\"cacheReadTokenCostPer1M\":0.0028,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.28,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":true,\"maxTokens\":384000,\"name\":\"deepseek-v4-flash\",\"promptTokenCostPer1M\":0.14,\"provider\":\"deepseek-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.003625,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.87,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":false,\"maxTokens\":384000,\"name\":\"deepseek-v4-pro\",\"promptTokenCostPer1M\":0.435,\"provider\":\"deepseek-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":false,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"deepseek-responses\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-3-small\",\"defaultModel\":\"gpt-5-mini\",\"displayName\":\"OpenAI\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.05,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-nano\",\"promptTokenCostPer1M\":0.1,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4o-mini\",\"promptTokenCostPer1M\":0.15,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.02,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":1.2,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.04,\"longContextCompletionTokenCostPer1M\":1.8,\"longContextPromptTokenCostPer1M\":0.4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-luna\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-3.5-turbo\",\"promptTokenCostPer1M\":0.5,\"provider\":\"openai\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-mini\",\"promptTokenCostPer1M\":0.4,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gpt-5-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":4.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o1-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o4-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1\",\"promptTokenCostPer1M\":2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o3\",\"promptTokenCostPer1M\":2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-max\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4o\",\"promptTokenCostPer1M\":2.5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":12,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.4,\"longContextCompletionTokenCostPer1M\":18,\"longContextPromptTokenCostPer1M\":4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-terra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2.5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"chatgpt-4o-latest\",\"promptTokenCostPer1M\":5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"name\":\"gpt-5.5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"gpt-5.6\"],\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-sol\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":30,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4-turbo\",\"promptTokenCostPer1M\":10,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1,\"cacheWriteTokenCostPer1M\":12.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":50,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":2,\"longContextCacheWriteTokenCostPer1M\":25,\"longContextCompletionTokenCostPer1M\":75,\"longContextPromptTokenCostPer1M\":20,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-6-astra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":10,\"provider\":\"openai\",\"supported\":{\"structuredOutputModes\":[\"native\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o1\",\"promptTokenCostPer1M\":15,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4\",\"promptTokenCostPer1M\":30,\"provider\":\"openai\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":120,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":15,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":false},\"completionTokenCostPer1M\":168,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":21,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":180,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"longContextCompletionTokenCostPer1M\":270,\"longContextPromptTokenCostPer1M\":60,\"longContextThreshold\":272000,\"name\":\"gpt-5.5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":30,\"provider\":\"openai\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"openai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultEmbedModel\":\"text-embedding-ada-002\",\"defaultModel\":\"gpt-4o\",\"displayName\":\"OpenAI Responses\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.05,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-nano\",\"promptTokenCostPer1M\":0.1,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4o-mini\",\"promptTokenCostPer1M\":0.15,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.02,\"cacheWriteTokenCostPer1M\":0.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":1.2,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.04,\"longContextCompletionTokenCostPer1M\":1.8,\"longContextPromptTokenCostPer1M\":0.4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-luna\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-nano\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-3.5-turbo\",\"promptTokenCostPer1M\":0.5,\"provider\":\"openai-responses\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1-mini\",\"promptTokenCostPer1M\":0.4,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":4.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4-mini\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":0.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o3-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":4.4,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o4-mini\",\"promptTokenCostPer1M\":1.1,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4.1\",\"promptTokenCostPer1M\":2,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":8,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o3\",\"promptTokenCostPer1M\":2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.1-codex-max\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.25,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":10,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"gpt-4o\",\"promptTokenCostPer1M\":2.5,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":12,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":0.4,\"longContextCompletionTokenCostPer1M\":18,\"longContextPromptTokenCostPer1M\":4,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-terra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-chat-latest\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":14,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-codex\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":1.75,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"code\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.4\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":2.5,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"chatgpt-4o-latest\",\"promptTokenCostPer1M\":5,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"name\":\"gpt-5.5\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"gpt-5.6\"],\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":30,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":1,\"longContextCompletionTokenCostPer1M\":45,\"longContextPromptTokenCostPer1M\":10,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-5.6-sol\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":5,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":30,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4-turbo\",\"promptTokenCostPer1M\":10,\"provider\":\"openai-responses\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1,\"cacheWriteTokenCostPer1M\":12.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":50,\"contextWindow\":1050000,\"currency\":\"usd\",\"isDefault\":false,\"longContextCacheReadTokenCostPer1M\":2,\"longContextCacheWriteTokenCostPer1M\":25,\"longContextCompletionTokenCostPer1M\":75,\"longContextPromptTokenCostPer1M\":20,\"longContextThreshold\":272000,\"maxTokens\":128000,\"name\":\"gpt-6-astra\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":10,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"o1\",\"promptTokenCostPer1M\":15,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":60,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-4\",\"promptTokenCostPer1M\":30,\"provider\":\"openai-responses\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":80,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"name\":\"o3-pro\",\"promptTokenCostPer1M\":20,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":120,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":15,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":168,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"gpt-5.2-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":21,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":false,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":false},\"completionTokenCostPer1M\":180,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"longContextCompletionTokenCostPer1M\":270,\"longContextPromptTokenCostPer1M\":60,\"longContextThreshold\":272000,\"name\":\"gpt-5.5-pro\",\"notSupported\":{\"temperature\":true,\"topP\":true},\"promptTokenCostPer1M\":30,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":600,\"currency\":\"usd\",\"isDefault\":false,\"isExpensive\":true,\"name\":\"o1-pro\",\"promptTokenCostPer1M\":150,\"provider\":\"openai-responses\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"openai-responses\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"grok-4.6\",\"displayName\":\"xAI Grok\",\"isDynamic\":false,\"models\":[{\"aliases\":[\"grok-4-1-fast-non-reasoning-latest\"],\"cacheReadTokenCostPer1M\":0.05,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4-1-fast-non-reasoning\",\"promptTokenCostPer1M\":0.2,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4-1-fast-reasoning-latest\"],\"cacheReadTokenCostPer1M\":0.05,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4-1-fast-reasoning\",\"promptTokenCostPer1M\":0.2,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":0.5,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3-mini\",\"promptTokenCostPer1M\":0.3,\"provider\":\"grok\",\"supported\":{\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.20-multi-agent-0309\",\"grok-4.20-multi-agent-latest\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.20-multi-agent\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.20-0309-non-reasoning\",\"grok-4.20-non-reasoning-latest\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.20-non-reasoning\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.20-0309-reasoning\",\"grok-4.20-reasoning-latest\",\"grok-4.20\",\"grok-4.20-0309\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":2000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.20-reasoning\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.3-latest\",\"grok-latest\"],\"cacheReadTokenCostPer1M\":0.2,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":2.5,\"contextWindow\":1000000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.3\",\"promptTokenCostPer1M\":1.25,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":4,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3-mini-fast\",\"promptTokenCostPer1M\":0.6,\"provider\":\"grok\",\"supported\":{\"thinkingBudget\":true},\"type\":\"text\"},{\"aliases\":[\"grok-4.5-latest\",\"grok-build-latest\"],\"cacheReadTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":6,\"contextWindow\":500000,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-4.5\",\"promptTokenCostPer1M\":2,\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3\",\"promptTokenCostPer1M\":3,\"provider\":\"grok\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"USD\",\"isDefault\":false,\"name\":\"grok-3-fast\",\"promptTokenCostPer1M\":5,\"provider\":\"grok\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[\"standard\",\"priority\"],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"currency\":\"USD\",\"isDefault\":true,\"name\":\"grok-4.6\",\"provider\":\"grok\",\"supported\":{\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"grok\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"command-r-plus\",\"displayName\":\"Cohere\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":0.6,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"command-light\",\"promptTokenCostPer1M\":0.3,\"provider\":\"cohere\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"command\",\"promptTokenCostPer1M\":0.5,\"provider\":\"cohere\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.5,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"command-r\",\"promptTokenCostPer1M\":0.5,\"provider\":\"cohere\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"command-r-plus\",\"promptTokenCostPer1M\":3,\"provider\":\"cohere\",\"type\":\"text\"}],\"name\":\"cohere\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"defaultModel\":\"reka-core\",\"displayName\":\"Reka\",\"isDynamic\":false,\"models\":[{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"reka-edge\",\"promptTokenCostPer1M\":0.4,\"provider\":\"reka\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2,\"currency\":\"usd\",\"isDefault\":false,\"name\":\"reka-flash\",\"promptTokenCostPer1M\":0.8,\"provider\":\"reka\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":true,\"name\":\"reka-core\",\"promptTokenCostPer1M\":3,\"provider\":\"reka\",\"type\":\"text\"}],\"name\":\"reka\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"claude-3-7-sonnet-latest\",\"displayName\":\"Anthropic\",\"isDynamic\":false,\"models\":[{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-haiku-20240307\",\"promptTokenCostPer1M\":0.25,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.03,\"cacheWriteTokenCostPer1M\":0.3,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":1.25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-haiku@20240307\",\"promptTokenCostPer1M\":0.25,\"provider\":\"anthropic\",\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":2.24,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-instant-1.2\",\"promptTokenCostPer1M\":0.8,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.08,\"cacheWriteTokenCostPer1M\":1,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":4,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-haiku-latest\",\"promptTokenCostPer1M\":0.8,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.1,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-haiku@20241022\",\"promptTokenCostPer1M\":1,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.1,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-haiku-4-5\",\"promptTokenCostPer1M\":1,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.1,\"cacheWriteTokenCostPer1M\":1.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":5,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-haiku-4-5@20251001\",\"promptTokenCostPer1M\":1,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":10,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-sonnet-5\",\"promptTokenCostPer1M\":2,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.2,\"cacheWriteTokenCostPer1M\":2.5,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":10,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-sonnet-5\",\"promptTokenCostPer1M\":2,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-sonnet-latest\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-sonnet-v2@20241022\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":8192,\"name\":\"claude-3-5-sonnet@20240620\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":true,\"maxTokens\":64000,\"name\":\"claude-3-7-sonnet-latest\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-3-7-sonnet@20250219\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-sonnet-20240229\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4-20250514\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-sonnet-4-5-20250929\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":200000,\"name\":\"claude-sonnet-4-5@20250929\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4-6\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4-6\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.3,\"cacheWriteTokenCostPer1M\":3.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":15,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-sonnet-4@20250514\",\"promptTokenCostPer1M\":3,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-opus-4-5-20251101\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":64000,\"name\":\"claude-opus-4-5@20251101\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"fastCacheReadTokenCostPer1M\":3,\"fastCacheWriteTokenCostPer1M\":37.5,\"fastCompletionTokenCostPer1M\":150,\"fastPromptTokenCostPer1M\":30,\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-6\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-6\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"fastCacheReadTokenCostPer1M\":3,\"fastCacheWriteTokenCostPer1M\":37.5,\"fastCompletionTokenCostPer1M\":150,\"fastPromptTokenCostPer1M\":30,\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-7\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-7\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"fastCacheReadTokenCostPer1M\":1,\"fastCacheWriteTokenCostPer1M\":12.5,\"fastCompletionTokenCostPer1M\":50,\"fastPromptTokenCostPer1M\":10,\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-8\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":0.5,\"cacheWriteTokenCostPer1M\":6.25,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":25,\"contextWindow\":1000000,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":128000,\"name\":\"claude-opus-4-8\",\"promptTokenCostPer1M\":5,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":false,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":25,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-2.1\",\"promptTokenCostPer1M\":8,\"provider\":\"anthropic\",\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-opus-latest\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":false,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":false,\"thinkingLevels\":[],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":4096,\"name\":\"claude-3-opus@20240229\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"structuredOutputs\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4-1-20250805\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4-1@20250805\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4-20250514\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"cacheReadTokenCostPer1M\":1.5,\"cacheWriteTokenCostPer1M\":18.75,\"capabilities\":{\"audioInput\":false,\"audioOutput\":false,\"imageOutput\":false,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true},\"completionTokenCostPer1M\":75,\"currency\":\"usd\",\"isDefault\":false,\"maxTokens\":32000,\"name\":\"claude-opus-4@20250514\",\"promptTokenCostPer1M\":15,\"provider\":\"anthropic\",\"supported\":{\"showThoughts\":true,\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"anthropic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenAI Compatible\",\"isDynamic\":true,\"models\":[],\"name\":\"openai-compatible\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":true,\"thinkingLevels\":[\"none\",\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"displayName\":\"Azure OpenAI\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-openai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":true,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3-contributor\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2-contributor\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.1\",\"provider\":\"meta\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"meta\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Chat Completions\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":true,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3-contributor\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2-contributor\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.1\",\"provider\":\"meta-chat\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\",\"json_object\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"meta-chat\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"]},\"defaultModel\":\"muse-spark-1.3\",\"displayName\":\"Meta Model API Messages\",\"isDynamic\":false,\"models\":[{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":true,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.3-contributor\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"appliesTo\":[\"prompt\",\"completion\"],\"providerTraining\":\"allowed\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.2-contributor\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"},{\"audio\":{\"input\":true,\"output\":false},\"capabilities\":{\"audioInput\":true,\"audioOutput\":false,\"imageInput\":true,\"imageOutput\":false,\"pdfInput\":true,\"serviceTiers\":[],\"showThoughts\":true,\"structuredOutputs\":true,\"temperature\":true,\"textInput\":true,\"textOutput\":true,\"thinkingBudget\":true,\"thinkingLevels\":[\"minimal\",\"low\",\"medium\",\"high\",\"highest\"],\"topP\":true,\"videoInput\":true},\"contextWindow\":1048576,\"dataUse\":{\"providerTraining\":\"not-used\"},\"isDefault\":false,\"modalities\":{\"input\":[\"text\",\"image\",\"audio\",\"video\",\"pdf\"],\"output\":[\"text\"]},\"name\":\"muse-spark-1.1\",\"provider\":\"meta-messages\",\"supported\":{\"operations\":[\"chat\"],\"showThoughts\":true,\"structuredOutputModes\":[\"native\",\"function\"],\"structuredOutputs\":true,\"thinkingBudget\":true},\"type\":\"text\"}],\"name\":\"meta-messages\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Together AI\",\"isDynamic\":true,\"models\":[],\"name\":\"together\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OpenRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"openrouter\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OrcaRouter\",\"isDynamic\":true,\"models\":[],\"name\":\"orcarouter\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Fireworks AI\",\"isDynamic\":true,\"models\":[],\"name\":\"fireworks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hugging Face Router\",\"isDynamic\":true,\"models\":[],\"name\":\"huggingface-router\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Amazon Bedrock\",\"isDynamic\":true,\"models\":[],\"name\":\"amazon-bedrock\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Azure AI Foundry\",\"isDynamic\":true,\"models\":[],\"name\":\"azure-foundry\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Vertex AI OpenAI Compatibility\",\"isDynamic\":true,\"models\":[],\"name\":\"vertex-ai\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Databricks Model Serving\",\"isDynamic\":true,\"models\":[],\"name\":\"databricks\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Model APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Groq\",\"isDynamic\":true,\"models\":[],\"name\":\"groq\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"flex\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cerebras Inference\",\"isDynamic\":true,\"models\":[],\"name\":\"cerebras\"},{\"capabilities\":{\"serviceTiers\":[\"standard\",\"priority\"],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"DeepInfra\",\"isDynamic\":true,\"models\":[],\"name\":\"deepinfra\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SambaNova Cloud\",\"isDynamic\":true,\"models\":[],\"name\":\"sambanova\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nebius AI Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"nebius\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Novita AI\",\"isDynamic\":true,\"models\":[],\"name\":\"novita\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Hyperbolic\",\"isDynamic\":true,\"models\":[],\"name\":\"hyperbolic\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SiliconFlow\",\"isDynamic\":true,\"models\":[],\"name\":\"siliconflow\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"FriendliAI\",\"isDynamic\":true,\"models\":[],\"name\":\"friendli\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Cloudflare Workers AI\",\"isDynamic\":true,\"models\":[],\"name\":\"cloudflare-workers-ai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Featherless AI\",\"isDynamic\":true,\"models\":[],\"name\":\"featherless\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Nscale\",\"isDynamic\":true,\"models\":[],\"name\":\"nscale\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"OVHcloud AI Endpoints\",\"isDynamic\":true,\"models\":[],\"name\":\"ovhcloud\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Scaleway Generative APIs\",\"isDynamic\":true,\"models\":[],\"name\":\"scaleway\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"NVIDIA NIM\",\"isDynamic\":true,\"models\":[],\"name\":\"nvidia-nim\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"RunPod vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"runpod-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"SageMaker vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"sagemaker-vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"vLLM\",\"isDynamic\":true,\"models\":[],\"name\":\"vllm\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Ollama\",\"isDynamic\":true,\"models\":[],\"name\":\"ollama\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LM Studio\",\"isDynamic\":true,\"models\":[],\"name\":\"lm-studio\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"llama.cpp Server\",\"isDynamic\":true,\"models\":[],\"name\":\"llama-cpp\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"LocalAI\",\"isDynamic\":true,\"models\":[],\"name\":\"localai\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Baseten Inference Engine\",\"isDynamic\":true,\"models\":[],\"name\":\"baseten-engine\"},{\"capabilities\":{\"serviceTiers\":[],\"thinking\":false,\"thinkingLevels\":[]},\"displayName\":\"Typesafe\",\"isDynamic\":true,\"models\":[],\"name\":\"typesafe\"}]}")
    return catalog
...
def provider_route_preprocess_request(features: Any, request: Any, processing: Any) -> Any:
    ...
    for message in prompt:
        ...
        is_user = _core_eq(role, "user")
        process_content = _core_and(content_is_list, is_user)
        if process_content:
            processed_content = []
            part_index = 0
            for part in content:
                ...
                is_file = _core_eq(part_type, "file")
                if is_file:
                    slot = _core_string_format("{}:{}", message_index, part_index)
                    file_part = _provider_route_file_content(features, part, processing, slot)
                    keep_file = _core_is_not_none(file_part)
                    if keep_file:
                        processed_content.append(file_part)
                    else:
                        pass
                else:
                    is_image = _core_eq(part_type, "image")
            ...
            content_count = _core_len(processed_content)
            single = _core_eq(content_count, 1)
            if single:
                only = _core_list_get(processed_content, 0, None)
                only_type = _core_get(only, "type", "")
                only_text = _core_eq(only_type, "text")
                if only_text:
                    text = _core_get(only, "text", "")
                    message_copy["content"] = text
                else:
                    pass
            else:
                pass
...
def _provider_route_file_content(features: Any, part: Any, processing: Any, slot: str) -> Any:
    _core_coverage_mark("_provider_route_file_content")
    supports_files = _provider_features_support(features, "files")
    if supports_files:
        empty = {}
        copy = _core_map_merge(empty, part)
        return copy
    else:
        pass
    snake_text = _core_get(part, "extracted_text", "")
    text = _core_get(part, "extractedText", snake_text)
    has_text = _core_truthy(text)
    no_text = _core_not(has_text)
    if no_text:
        empty_texts = {}
        texts = _core_get(processing, "file_texts", empty_texts)
        has_extracted = _core_map_contains(texts, slot)
        if has_extracted:
            text = _core_get(texts, slot, None)
        else:
            snake_fallback = _core_get(processing, "fallback_behavior", "degrade")
            fallback = _core_get(processing, "fallbackBehavior", snake_fallback)
            skip = _core_eq(fallback, "skip")
            if skip:
                return None
            else:
                pass
            error = _core_eq(fallback, "error")
            if error:
                err = _core_ai_error_unsupported("Files are not supported by the selected provider")
                raise err
            else:
                pass
            filename = _core_get(part, "filename", "undefined")
            text = _core_string_format("[File: {} - content not accessible by this provider]", filename)
    else:
        pass
    out = {}
    out["type"] = "text"
...
def provider_route_file_extractions(features: Any, request: Any) -> Any:
    _core_coverage_mark("provider_route_file_extractions")
    tasks = []
    supports = _provider_features_support(features, "files")
    if supports:
        return tasks
    else:
        pass
    empty = []
    snake_prompt = _core_get(request, "chat_prompt", empty)
    prompt = _core_get(request, "chatPrompt", snake_prompt)
    message_index = 0
    for message in prompt:
        role = _core_get(message, "role", "")
        user = _core_eq(role, "user")
        content = _core_get(message, "content", None)
        list = _core_type_is(content, "list")
        process = _core_and(user, list)
        if process:
            part_index = 0
            for part in content:
                type = _core_get(part, "type", "")
                file = _core_eq(type, "file")
                snake_text = _core_get(part, "extracted_text", "")
                text = _core_get(part, "extractedText", snake_text)
                has_text = _core_truthy(text)
                missing_text = _core_not(has_text)
                extract = _core_and(file, missing_text)
                if extract:
                    task = {}
                    slot = _core_string_format("{}:{}", message_index, part_index)
                    data = _core_get(part, "data", "")
                    snake_mime = _core_get(part, "mime_type", "")
                    mime = _core_get(part, "mimeType", snake_mime)
                    task["slot"] = slot
                    task["data"] = data
                    task["mime_type"] = mime
                    tasks.append(task)
...
def provider_realtime_ws_url(profile: str, model: str, api_key: str, options: Any) -> Any:
    ...
    if is_gemini:
        ...
        pass
    is_meta = _core_eq(grammar, "meta_asr_realtime")
    if is_meta:
        api_url = _core_get(options, "api_url", None)
        api_url = _core_get(options, "apiURL", api_url)
        base_override = _core_get(options, "base_url", api_url)
        base_override = _core_get(options, "baseUrl", base_override)
        has_override = _core_truthy(base_override)
        if has_override:
            trailing_slash = _core_string_ends_with(base_override, "/")
            if trailing_slash:
                base_length = _core_len(base_override)
                base_end = _core_add(base_length, -1)
                base_override = _core_string_slice(base_override, 0, base_end)
            else:
                pass
            base_override = _core_string_replace(base_override, "https://", "wss://")
            base_override = _core_string_replace(base_override, "http://", "ws://")
            base = _core_string_format("{}/asr/realtime", base_override)
        else:
            pass
        session_snake = _core_get(options, "session_id", None)
        session = _core_get(options, "sessionId", session_snake)
        has_session = _core_truthy(session)
        meta_url = base
        if has_session:
            meta_url = _core_string_format("{}?sessionId={}", base, session)
        else:
            pass
        out["url"] = meta_url
        out["headers"] = headers
...
def provider_apply_realtime_credentials(setup: Any, headers: Any) -> Any:
    _core_coverage_mark("provider_apply_realtime_credentials")
    lower = _core_get(headers, "authorization", None)
    authorization = _core_get(headers, "Authorization", lower)
    has_auth = _core_truthy(authorization)
    if has_auth:
        auth = {}
        auth["accessToken"] = authorization
        setup["authorization"] = auth
        return setup
    else:
        pass
    error = _core_ai_error_unsupported("Meta realtime credential provider must return an Authorization header")
    raise error
...
def provider_build_realtime_audio_setup(profile: str, request: Any, options: Any) -> Any:
    ...
    if is_gemini_live:
        ...
        pass
    if is_meta:
        meta_setup = _meta_asr_realtime_build_setup(descriptor, request, options)
        return meta_setup
    else:
        pass
...
def provider_build_realtime_audio_input(profile: str, request: Any) -> list[Any]:
    ...
    if is_gemini_live:
        ...
        pass
    if is_meta:
        meta_input = _meta_asr_realtime_build_input(descriptor, request)
        return meta_input
    else:
        pass
...
def _meta_asr_realtime_build_setup(descriptor: Any, request: Any, options: Any) -> Any:
    _core_coverage_mark("_meta_asr_realtime_build_setup")
    out = {}
    default_model = _core_get(descriptor, "defaultModel", "muse-voice-transcribe-1.0")
    model = _core_get(request, "model", default_model)
    out["model"] = model
    api_key_snake = _core_get(options, "api_key", "")
    api_key = _core_get(options, "apiKey", api_key_snake)
    authorization = {}
    access_token = _core_string_format("Bearer {}", api_key)
    ...
    configured_snake = _core_get(options, "realtime_transcription", empty_map)
    configured = _core_get(options, "realtimeTranscription", configured_snake)
    request_config_snake = _core_get(model_config, "realtime_transcription", empty_map)
    request_config = _core_get(model_config, "realtimeTranscription", request_config_snake)
    config = _core_map_merge(configured, request_config)
    mode = _core_get(config, "mode", "push_to_talk")
    mode_wire = mode
    is_push = _core_eq(mode, "push_to_talk")
    is_endpointing = _core_eq(mode, "endpointing")
    is_diarization = _core_eq(mode, "diarization")
    if is_push:
        mode_wire = "PUSH_TO_TALK"
    else:
        pass
    if is_endpointing:
        mode_wire = "ENDPOINTING"
    else:
        pass
    if is_diarization:
        mode_wire = "DIARIZATION"
    else:
        pass
    out["mode"] = mode_wire
    language_bias_snake = _core_get(config, "language_bias", None)
    language_bias = _core_get(config, "languageBias", language_bias_snake)
    has_language_bias = _core_truthy(language_bias)
    if has_language_bias:
        out["languageBias"] = language_bias
    else:
        pass
    keywords = _core_get(config, "keywords", None)
    has_keywords = _core_truthy(keywords)
    if has_keywords:
        out["keywords"] = keywords
    else:
        pass
    partial_snake = _core_get(config, "partial_mode", None)
    partial = _core_get(config, "partialMode", partial_snake)
    has_partial = _core_is_not_none(partial)
    if has_partial:
        partial_wire = partial
        is_cumulative = _core_eq(partial, "cumulative")
        is_delta = _core_eq(partial, "delta")
        if is_cumulative:
            partial_wire = "CUMULATIVE"
        else:
            pass
        if is_delta:
            partial_wire = "DELTA"
            ...
            pass
        out["partialMode"] = partial_wire
    else:
        pass
    progress_snake = _core_get(config, "emit_audio_progress", None)
    progress = _core_get(config, "emitAudioProgress", progress_snake)
    has_progress = _core_is_not_none(progress)
    if has_progress:
        out["emitAudioProgress"] = progress
    else:
        pass
    zdr_snake = _core_get(config, "zdr_override", None)
    zdr = _core_get(config, "zdrOverride", zdr_snake)
    has_zdr = _core_is_not_none(zdr)
    if has_zdr:
        out["zdrOverride"] = zdr
    else:
        pass
    request_audio = _core_get(request, "audio", empty_map)
    request_input = _core_get(request_audio, "input", empty_map)
    audio_descriptor = _core_get(descriptor, "audio", empty_map)
    input_descriptor = _core_get(audio_descriptor, "input", empty_map)
    ...
    not_mono = _core_not(mono)
    if not_mono:
        error = _core_ai_error_unsupported("Meta Voice realtime input requires mono PCM audio")
        raise error
    else:
        pass
    is_16k_lower = _core_gte(sample_rate, 16000)
    is_16k_upper = _core_lte(sample_rate, 16000)
    is_16k = _core_and(is_16k_lower, is_16k_upper)
    is_24k_lower = _core_gte(sample_rate, 24000)
    is_24k_upper = _core_lte(sample_rate, 24000)
    is_24k = _core_and(is_24k_lower, is_24k_upper)
    valid_rate = _core_or(is_16k, is_24k)
    invalid_rate = _core_not(valid_rate)
    if invalid_rate:
        error = _core_ai_error_unsupported("Meta Voice realtime input requires 16000 Hz or 24000 Hz PCM audio")
        raise error
    else:
        pass
    encoding = "PCM_24KHZ"
    if is_16k:
        ...
        pass
    out["audioEncoding"] = encoding
    return out


def _meta_asr_realtime_build_input(descriptor: Any, request: Any) -> list[Any]:
    _core_coverage_mark("_meta_asr_realtime_build_input")
    events = []
        ...
        if is_list:
            for part in content:
                ...
                if is_audio:
                    ...
                    valid = _core_or(is_pcm16, is_pcm)
                    invalid = _core_not(valid)
                    if invalid:
                        error = _core_ai_error_unsupported("Meta Voice realtime input requires PCM16 audio")
                        raise error
                    else:
                        pass
                    binary = {}
...
def provider_resolve_features(profile: str, model: str, options: Any) -> Any:
    ...
    profile = provider_chat_profile(profile, model)
    descriptor = provider_descriptor(profile)
    empty_map = {}
    ...
    for item in model_info:
        ...
        if matches:
            ...
            pass
    session_profile = provider_chat_profile(profile, model)
    responses = _core_eq(session_profile, "openai-responses")
    astra_model = _core_string_starts_with(model, "gpt-6-astra")
    astra_cache = _core_and(responses, astra_model)
    if astra_cache:
        features["asyncTools"] = True
        features["reasoningUpdates"] = True
        socket_snake = _core_get(options, "web_socket_transport", None)
        socket = _core_get(options, "webSocketTransport", socket_snake)
        factory_snake = _core_get(options, "web_socket_factory", None)
        factory = _core_get(options, "webSocketFactory", factory_snake)
        has_socket = _core_is_not_none(socket)
        has_factory = _core_is_not_none(factory)
        hook_present = _core_or(has_socket, has_factory)
        host_available = _core_get(options, "session_web_socket_available", False)
        can_steer = _core_or(hook_present, host_available)
        features["nativeSteering"] = can_steer
        cache_features = {}
        cache_types = []
        cache_types.append("ephemeral")
        cache_features["supported"] = True
        cache_features["types"] = cache_types
        features["caching"] = cache_features
    else:
        pass
    return features
...
def _provider_apply_request_rules(payload: Any, request: Any, rules: Any, options: Any) -> Any:
    ...
    if unforced:
        ...
        ax_generated = False
        choice_is_auto_object = False
        if choice_is_object:
            choice_type = _core_get(tool_choice, "type", "")
            choice_is_auto_object = _core_eq(choice_type, "auto")
            choice_function = _core_get(tool_choice, "function", empty_map)
            nested_choice_name = _core_get(choice_function, "name", "")
            choice_name = _core_get(tool_choice, "name", nested_choice_name)
            ax_generated = _core_eq(choice_name, "__axOutput")
        else:
            pass
        not_ax_generated = _core_not(ax_generated)
        object_not_auto = _core_and(choice_is_object, not_ax_generated)
        not_auto_object = _core_not(choice_is_auto_object)
        object_not_ax = _core_and(object_not_auto, not_auto_object)
        ...
        pass
    no_named = _core_eq(tool_choice_mode, "no-named")
    if no_named:
        tool_choice = _core_get(payload, "tool_choice", None)
        choice_is_object = _core_type_is(tool_choice, "object")
        if choice_is_object:
            choice_type = _core_get(tool_choice, "type", "")
            is_tool = _core_eq(choice_type, "tool")
            is_function = _core_eq(choice_type, "function")
            is_named = _core_or(is_tool, is_function)
            if is_named:
                choice_function = _core_get(tool_choice, "function", empty_map)
                nested_choice_name = _core_get(choice_function, "name", "")
                choice_name = _core_get(tool_choice, "name", nested_choice_name)
                is_output_choice = _core_eq(choice_name, "__axOutput")
                request_source = _core_get(request, "function_call_source", None)
                source_snake = _core_get(options, "function_call_source", request_source)
                source = _core_get(options, "functionCallSource", source_snake)
                ax_source = _core_eq(source, "ax")
                output_tools = []
                tools = _core_get(payload, "tools", empty_list)
                for tool in tools:
                    tool_function = _core_get(tool, "function", empty_map)
                    nested_tool_name = _core_get(tool_function, "name", "")
                    tool_name = _core_get(tool, "name", nested_tool_name)
                    is_output_tool = _core_eq(tool_name, "__axOutput")
                    if is_output_tool:
                        output_tools.append(tool)
                    else:
                        pass
                output_count = _core_len(output_tools)
                has_output_tool = _core_eq(output_count, 1)
                ax_output = _core_and(ax_source, is_output_choice)
                can_require_output = _core_and(ax_output, has_output_tool)
                if can_require_output:
                    payload["tools"] = output_tools
                    if is_tool:
                        any_choice = {}
                        any_choice["type"] = "any"
                        payload["tool_choice"] = any_choice
                    else:
                        payload["tool_choice"] = "required"
                else:
                    error = _core_ai_error_unsupported("deployment profile does not support explicitly named tool choices")
                    raise error
            else:
                pass
        else:
...
def _meta_prepare_responses_request(payload: Any, request: Any, options: Any) -> Any:
    _core_coverage_mark("_meta_prepare_responses_request")
    payload["store"] = False
    payload = _meta_strip_cache_control(payload)
    payload = _meta_apply_prompt_cache_options(payload, options, request)
    empty_list = []
    empty_reasoning = {}
    reasoning = _core_get(payload, "reasoning", empty_reasoning)
    show_snake = _core_get(options, "show_thoughts", True)
    show = _core_get(options, "showThoughts", show_snake)
    if show:
        reasoning["summary"] = "auto"
    else:
        pass
    payload["reasoning"] = reasoning
    include = _core_get(payload, "include", empty_list)
    has_encrypted = _core_contains(include, "reasoning.encrypted_content")
    needs_encrypted = _core_not(has_encrypted)
    if needs_encrypted:
    ...
    model = _core_get(payload, "model", "")
    is_image = _core_eq(model, "muse-image-1.0")
    is_voice = _core_eq(model, "muse-voice-transcribe-1.0")
    empty_functions = []
    functions = _core_get(request, "functions", empty_functions)
    has_functions = _core_truthy(functions)
    restricted_model = _core_or(is_image, is_voice)
    invalid_functions = _core_and(restricted_model, has_functions)
    if invalid_functions:
        error = _core_ai_error_unsupported("Meta Muse Image and Voice models do not permit function tools")
        raise error
    else:
        pass
    if is_image:
        empty_map = {}
        empty_image_input = []
        image_input = _core_get(payload, "input", empty_image_input)
        filtered_input = []
        for item in image_input:
            item_type = _core_get(item, "type", "message")
            is_reasoning_item = _core_eq(item_type, "reasoning")
            if is_reasoning_item:
                pass
            else:
                is_message_item = _core_eq(item_type, "message")
                is_image_item = _core_eq(item_type, "image_generation_call")
                allowed_item = _core_or(is_message_item, is_image_item)
                if allowed_item:
                    pass
                else:
                    error = _core_ai_error_unsupported("muse-image-1.0 accepts only text, reference images, and prior generated images")
                    raise error
                empty_item_content = []
                content = _core_get(item, "content", empty_item_content)
                is_content_list = _core_type_is(content, "list")
                if is_content_list:
                    for part in content:
                        part_type = _core_get(part, "type", "")
                        allowed_parts = []
                        allowed_parts.append("input_text")
                        allowed_parts.append("output_text")
                        allowed_parts.append("input_image")
                        allowed_part = _core_contains(allowed_parts, part_type)
                        if allowed_part:
                            pass
                        else:
                            message = _core_string_format("muse-image-1.0 does not support {} input", part_type)
                            error = _core_ai_error_unsupported(message)
                            raise error
                else:
                    pass
        ...
        model_config_snake = _core_get(request, "model_config", empty_map)
        model_config = _core_get(request, "modelConfig", model_config_snake)
        image_snake = _core_get(model_config, "image_generation", empty_map)
        image_config = _core_get(model_config, "imageGeneration", image_snake)
        tool = {}
        tool["type"] = "image_generation"
        size = _core_get(image_config, "size", None)
        has_size = _core_is_not_none(size)
        if has_size:
            tool["size"] = size
        else:
            pass
        output_format_snake = _core_get(image_config, "output_format", None)
        output_format = _core_get(image_config, "outputFormat", output_format_snake)
        resolved_output_format = _core_coalesce(output_format, "webp")
        tool["output_format"] = resolved_output_format
        image_search_snake = _core_get(image_config, "enable_image_search", None)
        image_search = _core_get(image_config, "enableImageSearch", image_search_snake)
        has_image_search = _core_is_not_none(image_search)
        if has_image_search:
            tool["enable_image_search"] = image_search
        else:
            pass
        web_search_snake = _core_get(image_config, "enable_web_search", None)
        web_search = _core_get(image_config, "enableWebSearch", web_search_snake)
        has_web_search = _core_is_not_none(web_search)
        if has_web_search:
            tool["enable_web_search"] = web_search
        else:
            pass
        shell_snake = _core_get(image_config, "enable_shell", None)
        shell = _core_get(image_config, "enableShell", shell_snake)
        has_shell = _core_is_not_none(shell)
        if has_shell:
            tool["enable_shell"] = shell
        else:
            pass
        strength_snake = _core_get(image_config, "reasoning_strength", None)
        strength = _core_get(image_config, "reasoningStrength", strength_snake)
        has_strength = _core_is_not_none(strength)
        if has_strength:
            tool["reasoning_strength"] = strength
        else:
            pass
        tools = []
        tools.append(tool)
        ...
        _core_map_delete(payload, "include")
    else:
        pass
    return payload


def _meta_prepare_messages_request(payload: Any, request: Any, options: Any) -> Any:
    _core_coverage_mark("_meta_prepare_messages_request")
    payload = _meta_strip_cache_control(payload)
    empty_map = {}
    model_config_snake = _core_get(request, "model_config", empty_map)
    model_config = _core_get(request, "modelConfig", model_config_snake)
    ...
    if has_budget:
        ...
        payload["thinking"] = thinking
        empty_output_config = {}
        output_config = _core_get(payload, "output_config", empty_output_config)
        output_config["effort"] = effort
        payload["output_config"] = output_config
    else:
        pass
    _core_map_delete(payload, "stop_sequences")
    _core_map_delete(payload, "top_k")
    _core_map_delete(payload, "reasoning_effort")
    return payload


def _meta_apply_prompt_cache_options(payload: Any, options: Any, request: Any) -> Any:
    _core_coverage_mark("_meta_apply_prompt_cache_options")
    empty_map = {}
    model_config_snake = _core_get(request, "model_config", empty_map)
    model_config = _core_get(request, "modelConfig", model_config_snake)
    cache_options = _core_map_merge(options, model_config)
    key_snake = _core_get(cache_options, "prompt_cache_key", None)
    key = _core_get(cache_options, "promptCacheKey", key_snake)
    session_snake = _core_get(cache_options, "session_id", None)
    session = _core_get(cache_options, "sessionId", session_snake)
    resolved_key = _core_coalesce(key, session)
    has_key = _core_truthy(resolved_key)
    if has_key:
        payload["prompt_cache_key"] = resolved_key
    else:
        pass
    retention_snake = _core_get(cache_options, "prompt_cache_retention", None)
    retention = _core_get(cache_options, "promptCacheRetention", retention_snake)
    has_retention = _core_truthy(retention)
    input = _core_get(payload, "input", None)
    is_responses = _core_is_not_none(input)
    send_retention = _core_and(has_retention, is_responses)
    if send_retention:
...
def _meta_strip_cache_control(payload: Any) -> Any:
    _core_coverage_mark("_meta_strip_cache_control")
    empty_list = []
    input = _core_get(payload, "input", empty_list)
    input_is_list = _core_type_is(input, "list")
    if input_is_list:
        for item in input:
            _core_map_delete(item, "cache_control")
            content = _core_get(item, "content", empty_list)
            content_is_list = _core_type_is(content, "list")
            if content_is_list:
                for part in content:
                    _core_map_delete(part, "cache_control")
                    nested = _core_get(part, "content", empty_list)
                    nested_is_list = _core_type_is(nested, "list")
                    if nested_is_list:
                        for nested_part in nested:
                            _core_map_delete(nested_part, "cache_control")
                    else:
                        pass
            else:
                pass
    ...
    for message in messages:
        content = _core_get(message, "content", empty_list)
        content_is_list = _core_type_is(content, "list")
        if content_is_list:
            for part in content:
                _core_map_delete(part, "cache_control")
            ...
            pass
    system = _core_get(payload, "system", empty_list)
    system_is_list = _core_type_is(system, "list")
    if system_is_list:
        for part in system:
            _core_map_delete(part, "cache_control")
    else:
    ...
    tools = _core_get(payload, "tools", empty_list)
    for tool in tools:
        _core_map_delete(tool, "cache_control")
    _core_map_delete(payload, "prompt_cache_options")
    return payload
...
def provider_normalize_chat_response(profile: str, raw: Any, ai_name: str, model: str, context: Any) -> AxChatResponse:
    ...
    response = _provider_normalize_image_outputs(response, context, model)
    return response


def provider_normalize_stream_delta(profile: str, raw: Any, state: Any, ai_name: str, model: str, context: Any) -> AxChatResponse:
    ...
    if is_responses:
        ...
        if is_gemini:
            ...
            if is_anthropic:
                ...
                response = compatible_response
    astra = _core_string_starts_with(model, "gpt-6-astra")
    session_capable = _core_and(is_responses, astra)
    if session_capable:
        empty_session_state = {}
        session_state = _core_get(state, "session_wire", empty_session_state)
        session_events = openai_responses_session_event(raw, session_state, model)
        state["session_wire"] = session_state
        response["session_events"] = session_events
    else:
        pass
    response = _provider_normalize_image_outputs(response, context, model)
    return response
...
def _provider_normalize_image_outputs(response: Any, context: Any, model: str) -> Any:
    _core_coverage_mark("_provider_normalize_image_outputs")
    format = "png"
    is_meta_image = _core_eq(model, "muse-image-1.0")
    if is_meta_image:
        format = "webp"
    else:
        pass
    empty = []
    tools = _core_get(context, "tools", empty)
    for tool in tools:
        type = _core_get(tool, "type", "")
        is_image = _core_eq(type, "image_generation")
        if is_image:
            format = _core_get(tool, "output_format", format)
        else:
            pass
    default_mime = _core_string_format("image/{}", format)
    results = _core_get(response, "results", empty)
    for result in results:
        images = _core_get(result, "images", empty)
        for image in images:
            image["mime_type"] = default_mime
            url = _core_get(image, "url", "")
            is_data_url = _core_string_starts_with(url, "data:")
            if is_data_url:
                parts = _core_string_split_once(url, ";base64,")
                found = _core_get(parts, "found", False)
                if found:
                    header = _core_get(parts, "left", "")
                    mime = _core_string_slice(header, 5)
                    data = _core_get(parts, "right", "")
                    image["mime_type"] = mime
                    image["data"] = data
                    _core_map_delete(image, "url")
                else:
                    pass
            else:
                pass
...
def provider_build_transcribe_request(profile: str, request: Any) -> Any:
    ...
    is_meta = _core_eq(dialect, "meta-transcription")
    payload = {}
    if is_gemini:
        ...
        if is_xai:
            ...
            if is_meta:
                meta_payload = _meta_build_transcribe_request(request)
...
def provider_normalize_transcribe_response(profile: str, raw: Any, request: Any) -> Any:
    ...
    if is_gemini:
        ...
        pass
    if is_meta:
        meta_out = _meta_normalize_transcribe_response(raw, request)
        return meta_out
    else:
        pass
...
def _meta_build_transcribe_request(request: Any) -> Any:
    _core_coverage_mark("_meta_build_transcribe_request")
    payload = {}
    request_file = _core_get(request, "file", None)
    audio = _core_get(request, "audio", request_file)
    payload["audio"] = audio
    body = {}
    body["audioEncoding"] = "WAV"
    model = _core_get(request, "model", "muse-voice-transcribe-1.0")
    model_ok = _core_eq(model, "muse-voice-transcribe-1.0")
    model_bad = _core_not(model_ok)
    if model_bad:
        error = _core_ai_error_unsupported("Meta Voice transcribe requires muse-voice-transcribe-1.0")
        raise error
    else:
        pass
    format = _core_get(audio, "format", None)
    has_format = _core_is_not_none(format)
    if has_format:
        format_ok = _core_eq(format, "wav")
        format_bad = _core_not(format_ok)
        if format_bad:
            error = _core_ai_error_unsupported("Meta Voice batch transcription requires WAV audio")
            raise error
        else:
            pass
    else:
        pass
    channels = _core_get(audio, "channels", None)
    has_channels = _core_is_not_none(channels)
    if has_channels:
        mono_low = _core_gte(channels, 1)
        mono_high = _core_lte(channels, 1)
        mono = _core_and(mono_low, mono_high)
        not_mono = _core_not(mono)
        if not_mono:
            error = _core_ai_error_unsupported("Meta Voice batch transcription requires mono audio")
            raise error
        else:
            pass
    else:
        pass
    sample_rate_snake = _core_get(audio, "sample_rate", None)
    sample_rate = _core_get(audio, "sampleRate", sample_rate_snake)
    has_sample_rate = _core_is_not_none(sample_rate)
    if has_sample_rate:
        is_16_low = _core_gte(sample_rate, 16000)
        is_16_high = _core_lte(sample_rate, 16000)
        is_16 = _core_and(is_16_low, is_16_high)
        is_24_low = _core_gte(sample_rate, 24000)
        is_24_high = _core_lte(sample_rate, 24000)
        is_24 = _core_and(is_24_low, is_24_high)
        rate_ok = _core_or(is_16, is_24)
        rate_bad = _core_not(rate_ok)
        if rate_bad:
            error = _core_ai_error_unsupported("Meta Voice batch transcription requires 16000 Hz or 24000 Hz audio")
            raise error
        else:
            pass
    else:
        pass
    mode = _core_get(request, "mode", None)
    has_mode = _core_is_not_none(mode)
    mode_wire = mode
    is_push = _core_eq(mode, "push_to_talk")
    is_endpointing = _core_eq(mode, "endpointing")
    ...
    has_language = _core_is_not_none(language)
    language_bias_snake = _core_get(request, "language_bias", None)
    language_bias = _core_get(request, "languageBias", language_bias_snake)
    has_language_bias = _core_truthy(language_bias)
    keywords = _core_get(request, "keywords", None)
    has_keywords = _core_truthy(keywords)
    prompt = _core_get(request, "prompt", None)
    has_prompt = _core_truthy(prompt)
    has_unsupported_bias = _core_or(has_language, has_prompt)
    if has_unsupported_bias:
        error = _core_ai_error_unsupported("Meta Voice uses languageBias and keywords instead of language or prompt")
        raise error
    else:
        pass
    partial_snake = _core_get(request, "partial_mode", None)
    partial = _core_get(request, "partialMode", partial_snake)
    has_partial = _core_is_not_none(partial)
    partial_wire = partial
    is_cumulative = _core_eq(partial, "cumulative")
    is_delta = _core_eq(partial, "delta")
    ...
    if is_delta:
        ...
        pass
    progress_snake = _core_get(request, "emit_audio_progress", None)
    progress = _core_get(request, "emitAudioProgress", progress_snake)
    has_progress = _core_is_not_none(progress)
    session_snake = _core_get(request, "session_id", None)
    session = _core_get(request, "sessionId", session_snake)
    has_session = _core_is_not_none(session)
    if has_progress:
        body["emitAudioProgress"] = progress
    else:
        pass
    if has_keywords:
    ...
    if has_session:
        ...
        pass
    request_json = _core_json_stringify(body)
    payload["request"] = request_json
    return payload


def _meta_normalize_transcribe_response(raw: Any, request: Any) -> Any:
    _core_coverage_mark("_meta_normalize_transcribe_response")
    source = raw
    empty_events = []
    events = _core_get(raw, "events", empty_events)
    has_events = _core_truthy(events)
    if has_events:
        state = {}
        partial_snake = _core_get(request, "partial_mode", None)
        partial = _core_get(request, "partialMode", partial_snake)
        state["partial_mode"] = partial
        for event in events:
            ignored = _meta_asr_realtime_normalize_event(event, state, "meta", "muse-voice-transcribe-1.0")
        event_source = {}
        empty_turn_map = {}
        turn_map = _core_get(state, "turns", empty_turn_map)
        speaker_map = _core_get(state, "speakers", empty_turn_map)
        start_map = _core_get(state, "turn_starts", empty_turn_map)
        end_map = _core_get(state, "turn_ends", empty_turn_map)
        turn_ids = _core_map_keys(turn_map)
        transcript_parts = []
        event_turns = []
        for turn_id in turn_ids:
            turn_text = _core_get(turn_map, turn_id, "")
            transcript_parts.append(turn_text)
            turn = {}
            turn["turnId"] = turn_id
            turn["transcript"] = turn_text
            speaker = _core_get(speaker_map, turn_id, None)
            has_speaker = _core_is_not_none(speaker)
            if has_speaker:
                turn["speaker"] = speaker
            else:
                pass
            start = _core_get(start_map, turn_id, None)
            has_start = _core_is_not_none(start)
            if has_start:
                turn["startMs"] = start
            else:
                pass
            end = _core_get(end_map, turn_id, None)
        ...
        event_transcript = _core_string_join("\n", transcript_parts)
        event_source["transcript"] = event_transcript
        event_source["turns"] = event_turns
        event_session = _core_get(state, "session_id", None)
        has_event_session = _core_is_not_none(event_session)
        if has_event_session:
            event_source["sessionId"] = event_session
        else:
            pass
        event_progress = _core_get(state, "audio_processed_ms", None)
        has_event_progress = _core_is_not_none(event_progress)
        if has_event_progress:
            event_source["audioDurationMs"] = event_progress
            event_source["audioProcessedMs"] = event_progress
        else:
            pass
        source = event_source
    else:
        pass
    out = {}
    text_raw = _core_get(source, "text", "")
    text = _core_get(source, "transcript", text_raw)
    out["text"] = text
    language = _core_get(source, "language", None)
    has_language = _core_is_not_none(language)
    if has_language:
        out["language"] = language
    else:
        pass
    duration_ms_snake = _core_get(source, "audio_duration_ms", None)
    duration_ms = _core_get(source, "audioDurationMs", duration_ms_snake)
    has_duration_ms = _core_is_not_none(duration_ms)
    if has_duration_ms:
        duration = _core_div(duration_ms, 1000)
        out["duration"] = duration
    else:
        duration = _core_get(source, "duration", None)
        has_duration = _core_is_not_none(duration)
        if has_duration:
            out["duration"] = duration
        else:
            pass
    session_snake = _core_get(source, "session_id", None)
    session = _core_get(source, "sessionId", session_snake)
    has_session = _core_is_not_none(session)
    if has_session:
        ...
        pass
    empty_turns = []
    turns = _core_get(source, "turns", empty_turns)
    segments = []
    for turn in turns:
        segment = {}
        turn_id_snake = _core_get(turn, "turn_id", None)
        turn_id = _core_get(turn, "turnId", turn_id_snake)
        has_turn_id = _core_is_not_none(turn_id)
        if has_turn_id:
            segment["id"] = turn_id
        else:
            pass
        turn_text_raw = _core_get(turn, "text", "")
        turn_text = _core_get(turn, "transcript", turn_text_raw)
        segment["text"] = turn_text
        start_snake = _core_get(turn, "start_ms", None)
        start_ms = _core_get(turn, "startMs", start_snake)
        has_start = _core_is_not_none(start_ms)
        if has_start:
            start = _core_div(start_ms, 1000)
            segment["start"] = start
        else:
            pass
        end_snake = _core_get(turn, "end_ms", None)
        end_ms = _core_get(turn, "endMs", end_snake)
        has_end = _core_is_not_none(end_ms)
        if has_end:
            end = _core_div(end_ms, 1000)
            segment["end"] = end
        else:
            pass
        speaker_id_snake = _core_get(turn, "speaker_id", None)
        speaker_id = _core_get(turn, "speakerId", speaker_id_snake)
        speaker = _core_get(turn, "speaker", speaker_id)
        has_speaker = _core_is_not_none(speaker)
        if has_speaker:
    ...
    has_segments = _core_truthy(segments)
    if has_segments:
        out["segments"] = segments
    else:
        pass
    audio_progress_snake = _core_get(source, "audio_processed_ms", None)
    audio_progress = _core_get(source, "audioProcessedMs", audio_progress_snake)
    has_audio_progress = _core_is_not_none(audio_progress)
    if has_audio_progress:
        out["audio_processed_ms"] = audio_progress
    else:
        pass
    return out
...
def provider_normalize_realtime_event(profile: str, event: Any, state: Any, ai_name: str, model: str) -> AxChatResponse:
    ...
    if is_gemini_live:
        ...
        pass
    if is_meta:
        meta_response = _meta_asr_realtime_normalize_event(event, state, ai_name, model)
...
def openai_responses_build_chat_request(request: AxChatRequest) -> Any:
    ...
    for message in prompt:
        ...
        if is_system:
            ...
            if is_assistant:
                ...
                thought_blocks_snake = _core_get(message, "thought_blocks", empty_thought_blocks)
                thought_blocks = _core_get(message, "thoughtBlocks", thought_blocks_snake)
                has_structured_thought = False
                for thought_block in thought_blocks:
                    block_data = _core_get(thought_block, "data", "")
                    block_phase = _core_get(thought_block, "phase", "")
                    is_commentary = _core_eq(block_phase, "commentary")
                    if is_commentary:
                        commentary_item = {}
                        commentary_item["type"] = "message"
                        commentary_item["role"] = "assistant"
                        commentary_item["phase"] = "commentary"
                        commentary_part = {}
                        commentary_part["type"] = "output_text"
                        commentary_part["text"] = block_data
                        commentary_content = []
                        commentary_content.append(commentary_part)
                        commentary_item["content"] = commentary_content
                        input.append(commentary_item)
                        has_structured_thought = True
                    else:
                        pass
                    legacy_encrypted = _core_get(thought_block, "encrypted", False)
                    legacy_cipher = ""
                    legacy_summary = block_data
                    if legacy_encrypted:
                        legacy_cipher = block_data
                        legacy_summary = ""
                    else:
                        pass
                    encrypted_snake = _core_get(thought_block, "encrypted_content", legacy_cipher)
                    encrypted = _core_get(thought_block, "encryptedContent", encrypted_snake)
                    has_encrypted = _core_truthy(encrypted)
                    if has_encrypted:
                        reasoning_item = {}
                        reasoning_item["type"] = "reasoning"
                        legacy_id = _core_get(thought_block, "signature", None)
                        block_id = _core_get(thought_block, "id", legacy_id)
                        has_block_id = _core_is_not_none(block_id)
                        if has_block_id:
                            reasoning_item["id"] = block_id
                        else:
                            pass
                        summary_text = _core_get(thought_block, "summary", legacy_summary)
                        summary_part = {}
                        summary_part["type"] = "summary_text"
                        summary_part["text"] = summary_text
                        summary = []
                        has_summary_text = _core_truthy(summary_text)
                        astra_summary = _core_string_starts_with(model, "gpt-6-astra")
                        retain_empty_summary = _core_not(astra_summary)
                        include_summary = _core_or(has_summary_text, retain_empty_summary)
                        if include_summary:
                ...
                thought = _core_get(message, "thought", None)
                has_thought = _core_truthy(thought)
                no_structured_thought = _core_not(has_structured_thought)
                use_legacy_thought = _core_and(has_thought, no_structured_thought)
                if use_legacy_thought:
                    reasoning_item = {}
                    reasoning_item["type"] = "reasoning"
                    ...
                    pass
                empty_images = []
                images = _core_get(message, "images", empty_images)
                for image in images:
                    image_item = {}
                    image_item["type"] = "image_generation_call"
                    image_id = _core_get(image, "id", None)
                    has_image_id = _core_truthy(image_id)
                    missing_image_id = _core_not(has_image_id)
                    if missing_image_id:
                        error = _core_ai_error_unsupported("Responses image replay requires the provider image id")
                        raise error
                    else:
                        pass
                    image_item["id"] = image_id
                    image_item["status"] = "completed"
                    no_result = _core_none()
                    image_item["result"] = no_result
                    input.append(image_item)
                content = _core_get(message, "content", None)
                has_content = _core_truthy(content)
                if has_content:
    ...
    if has_functions:
        ...
        for fn in functions:
            ...
            session_enabled = _core_get(request, "session_enabled", False)
            execution = _core_get(fn, "execution", "blocking")
            background = _core_eq(execution, "background")
            async_enabled = _core_and(session_enabled, background)
            if async_enabled:
                tool["async"] = True
            else:
                pass
    ...
    if has_response_format:
        ...
        if is_json_schema:
            ...
            astra_format = _core_string_starts_with(model, "gpt-6-astra")
            if astra_format:
                schema_body = _core_get(schema, "schema", schema)
                schema_name = _core_get(schema, "name", "output")
                schema_strict = _core_get(schema, "strict", True)
                format["name"] = schema_name
                format["schema"] = schema_body
                format["strict"] = schema_strict
            else:
    ...
    if has_parallel:
        ...
        pass
    session_input = _core_get(request, "session_input", None)
    has_session_input = _core_is_not_none(session_input)
    if has_session_input:
        payload["input"] = session_input
        previous_id = _core_get(request, "previous_response_id", None)
        payload["previous_response_id"] = previous_id
    else:
        pass
    _openai_copy_config_key_impl(payload, model_config, "truncation", "truncation")
    _openai_copy_config_key_impl(payload, model_config, "context_management", "context_management")
    _openai_copy_config_key_impl(payload, model_config, "agents", "agents")
    validated = openai_responses_validate_session_request(payload)
    return validated
...
def _openai_responses_input_item_impl(message: Any) -> Any:
    ...
    if is_assistant:
        ...
        pass
    phase = _core_get(message, "phase", None)
    has_phase = _core_is_not_none(phase)
    if has_phase:
        out["phase"] = phase
    else:
...
def _openai_responses_content_part_impl(part: Any, role: str) -> Any:
    ...
    if is_file:
        out = {}
        file_uri_snake = _core_get(part, "file_uri", None)
        file_uri = _core_get(part, "fileUri", file_uri_snake)
        mime_snake = _core_get(part, "mime_type", "application/octet-stream")
        mime = _core_get(part, "mimeType", mime_snake)
        is_image_file = _core_string_starts_with(mime, "image/")
        is_video = _core_string_starts_with(mime, "video/")
        has_uri = _core_truthy(file_uri)
        uri_video = _core_and(is_video, has_uri)
        if is_image_file:
            out["type"] = "input_image"
            data = _core_get(part, "data", "")
            data_url = _core_string_format("data:{};base64,{}", mime, data)
            image_url = _core_coalesce(file_uri, data_url)
            out["image_url"] = image_url
            out["detail"] = "auto"
        else:
            if uri_video:
                out["type"] = "input_video"
                out["video_url"] = file_uri
            else:
                out["type"] = "input_file"
                if has_uri:
                    out["file_url"] = file_uri
                else:
                    data = _core_get(part, "data", "")
                    file_data = _core_string_format("data:{};base64,{}", mime, data)
...
def _openai_responses_copy_cache_control_impl(target: Any, source: Any) -> None:
    _core_coverage_mark("_openai_responses_copy_cache_control_impl")
    cache = _core_get(source, "cache", False)
    if cache:
        cache_control = {}
...
def _openai_responses_merge_output_item_impl(result: Any, item: Any) -> None:
    ...
    if is_message:
        ...
        phase = _core_get(item, "phase", None)
        is_commentary = _core_eq(phase, "commentary")
        if is_commentary:
            result["thought"] = content
            existing_blocks = _core_get(result, "thought_blocks", empty_content)
            commentary_block = {}
            commentary_block["data"] = content
            commentary_block["encrypted"] = False
            commentary_block["id"] = item_id
            commentary_block["phase"] = "commentary"
            existing_blocks.append(commentary_block)
            result["thought_blocks"] = existing_blocks
        else:
    ...
    if is_reasoning:
        ...
        has_thought = _core_truthy(thought)
        has_encrypted = _core_truthy(encrypted)
        has_block = _core_or(has_thought, has_encrypted)
        if has_thought:
        ...
        encrypted = _core_get(item, "encrypted_content", None)
        has_encrypted = _core_truthy(encrypted)
        preserve_reasoning = _core_or(has_thought, has_encrypted)
        if preserve_reasoning:
            existing_blocks = _core_get(result, "thought_blocks", empty_list)
            thought_block = {}
            thought_block["data"] = thought
            thought_block["encrypted"] = has_encrypted
            if has_encrypted:
                thought_block["id"] = item_id
                thought_block["encrypted_content"] = encrypted
            else:
                pass
            summary = _openai_responses_reasoning_summary_impl(item)
            has_summary = _core_truthy(summary)
            if has_summary:
                thought_block["summary"] = summary
            else:
                pass
            existing_blocks.append(thought_block)
            result["thought_blocks"] = existing_blocks
        else:
            pass
    else:
        pass
    is_image_generation = _core_eq(type, "image_generation_call")
    if is_image_generation:
        item_id = _core_get(item, "id", "0")
        result["id"] = item_id
        image_result = _core_get(item, "result", None)
        has_image_result = _core_truthy(image_result)
        if has_image_result:
            image = {}
            image["id"] = item_id
            image["mime_type"] = "image/png"
            is_http = _core_string_starts_with(image_result, "http")
            is_data_url = _core_string_starts_with(image_result, "data:")
            is_url = _core_or(is_http, is_data_url)
            if is_url:
                image["url"] = image_result
            else:
                image["data"] = image_result
            images = _core_get(result, "images", empty_list)
            images.append(image)
...
def _openai_responses_reasoning_text_impl(item: Any) -> str:
    ...
    if content_is_list:
        ...
        if has_content:
            ...
            pass
    summary_text = _openai_responses_reasoning_summary_impl(item)
    return summary_text


def _openai_responses_reasoning_summary_impl(item: Any) -> str:
    _core_coverage_mark("_openai_responses_reasoning_summary_impl")
    empty_summary = []
...
def _openai_responses_function_call_impl(item: Any) -> Any:
    ...
    has_args = _core_truthy(args)
    parse_args = _core_and(args_is_string, has_args)
    if parse_args:
        try:
...
def openai_responses_normalize_stream_delta(event: Any, state: Any, ai_name: str, model: str) -> AxChatResponse:
    ...
    is_failed = _core_eq(type, "response.failed")
    if is_failed:
        provider_error = _core_get(event_response, "error", empty_response)
        error_message = _core_get(provider_error, "message", "Responses stream failed")
        error = _core_ai_error_response(error_message, event_response)
        raise error
    else:
        pass
    is_error = _core_eq(type, "error")
    if is_error:
        error_message = _core_get(event, "message", "Responses stream failed")
    ...
    if is_text_delta:
        ...
        delta_phase = _core_get(phases, event_item_id, None)
        is_commentary = _core_eq(delta_phase, "commentary")
        if is_commentary:
            result["thought"] = text_delta
            thought_blocks = []
            thought_block = {}
            thought_block["data"] = text_delta
            thought_block["encrypted"] = False
            thought_block["id"] = event_item_id
            thought_block["phase"] = "commentary"
            thought_blocks.append(thought_block)
            result["thought_blocks"] = thought_blocks
        else:
            result["content"] = text_delta
            has_delta_phase = _core_is_not_none(delta_phase)
            if has_delta_phase:
                result["phase"] = delta_phase
            else:
                pass
    else:
        pass
    is_reasoning_delta = _core_eq(type, "response.reasoning_text.delta")
    is_summary_delta = _core_eq(type, "response.reasoning_summary_text.delta")
    is_reasoning_delta = _core_or(is_reasoning_delta, is_summary_delta)
    if is_reasoning_delta:
        ...
        thought_block["encrypted"] = False
        is_meta_model = _core_string_starts_with(model, "muse-")
        if is_meta_model:
            thought_block["id"] = event_item_id
        else:
            pass
    ...
    is_summary_text_done = _core_eq(type, "response.reasoning_summary_text.done")
    is_summary_done = _core_eq(type, "response.reasoning_summary.done")
    is_reasoning_done = _core_or(is_reasoning_done, is_summary_text_done)
    is_reasoning_done = _core_or(is_reasoning_done, is_summary_done)
    if is_reasoning_done:
        ...
        thought_block["encrypted"] = False
        is_meta_model_done = _core_string_starts_with(model, "muse-")
        if is_meta_model_done:
            thought_block["id"] = event_item_id
            thought_block["summary"] = reasoning_text
        else:
            pass
        thought_blocks.append(thought_block)
        result["thought_blocks"] = thought_blocks
    ...
    if is_output_added:
        ...
        if is_message_item:
            ...
            item_phase = _core_get(item, "phase", None)
            has_item_phase = _core_is_not_none(item_phase)
            if has_item_phase:
                phases[item_id] = item_phase
                state["phases"] = phases
            else:
                pass
        else:
        ...
        pass
    is_output_done = _core_eq(type, "response.output_item.done")
    if is_output_done:
        empty_done_item = {}
    ...
    if is_partial_image:
        partial_image = _core_get(event, "partial_image_b64", "")
        image = {}
        image["id"] = event_item_id
        image["data"] = partial_image
        image["mime_type"] = "image/png"
        image["is_delta"] = True
        images = []
        images.append(image)
    ...
    is_incomplete = _core_eq(type, "response.incomplete")
    if is_incomplete:
...
def _meta_asr_realtime_normalize_event(event: Any, state: Any, ai_name: str, model: str) -> AxChatResponse:
    _core_coverage_mark("_meta_asr_realtime_normalize_event")
    type = _core_get(event, "type", "")
    is_error = _core_eq(type, "error")
    if is_error:
        empty_error = {}
        error_payload = _core_get(event, "error", empty_error)
        nested_message = _core_get(error_payload, "message", "Meta Voice realtime transcription error")
        message = _core_get(event, "message", nested_message)
        error = _core_ai_error_response(message, event)
        raise error
    else:
        pass
    result = {}
    result["index"] = 0
    turn_snake = _core_get(event, "turn_id", None)
    turn_id = _core_get(event, "turnId", turn_snake)
    has_turn = _core_is_not_none(turn_id)
    if has_turn:
        pass
    else:
        turn_id = _core_get(state, "latest_turn_id", "0")
    turn_id = _core_string_format("{}", turn_id)
    result["id"] = turn_id
    result["content"] = ""
    empty_calls = []
    result["function_calls"] = empty_calls
    none_finish = _core_none()
    result["finish_reason"] = none_finish
    session_snake = _core_get(event, "session_id", None)
    session = _core_get(event, "sessionId", session_snake)
    has_session = _core_is_not_none(session)
    if has_session:
        state["session_id"] = session
    else:
        pass
    is_speech_start = _core_eq(type, "speechStart")
    if is_speech_start:
        state["latest_turn_id"] = turn_id
        empty_turns = {}
        turns = _core_get(state, "turns", empty_turns)
        existing = _core_get(turns, turn_id, "")
        turns[turn_id] = existing
        state["turns"] = turns
    else:
        pass
    progress_snake = _core_get(event, "audio_processed_ms", None)
    progress = _core_get(event, "audioProcessedMs", progress_snake)
    has_progress = _core_is_not_none(progress)
    if has_progress:
        result["audio_processed_ms"] = progress
        state["audio_processed_ms"] = progress
        empty_times = {}
        starts = _core_get(state, "turn_starts", empty_times)
        if is_speech_start:
            starts[turn_id] = progress
            state["turn_starts"] = starts
        else:
            pass
        is_speech_end_time = _core_eq(type, "speechEnd")
        is_speech_complete_time = _core_eq(type, "speechComplete")
        is_turn_end = _core_or(is_speech_end_time, is_speech_complete_time)
        if is_turn_end:
            ends = _core_get(state, "turn_ends", empty_times)
            ends[turn_id] = progress
            state["turn_ends"] = ends
        else:
            pass
    else:
        pass
    empty_speakers = {}
    speakers = _core_get(state, "speakers", empty_speakers)
    known_speaker = _core_get(speakers, turn_id, None)
    speaker_label = _core_get(event, "label", None)
    speaker_event = _core_get(event, "speaker", speaker_label)
    speaker = _core_coalesce(speaker_event, known_speaker)
    has_speaker = _core_is_not_none(speaker)
    if has_speaker:
        speakers[turn_id] = speaker
        state["speakers"] = speakers
        result["name"] = speaker
    else:
        pass
    is_transcript = _core_eq(type, "transcript")
    if is_transcript:
        text_raw = _core_get(event, "text", "")
        text = _core_get(event, "transcript", text_raw)
        empty_turns = {}
        turns = _core_get(state, "turns", empty_turns)
        previous = _core_get(turns, turn_id, "")
        state_partial = _core_get(state, "partial_mode", None)
        partial_snake = _core_get(event, "partial_mode", state_partial)
        partial_mode = _core_get(event, "partialMode", partial_snake)
        is_delta_mode = _core_eq(partial_mode, "DELTA")
        is_delta_mode_lower = _core_eq(partial_mode, "delta")
        is_delta_mode = _core_or(is_delta_mode, is_delta_mode_lower)
        is_final_turn = _core_get(event, "final", False)
        not_final = _core_not(is_final_turn)
        append = _core_and(is_delta_mode, not_final)
        complete_text = text
        if append:
            complete_text = _core_string_format("{}{}", previous, text)
        else:
            pass
        turns[turn_id] = complete_text
        state["turns"] = turns
        snapshot = {}
        snapshot["text"] = complete_text
        snapshot["is_final"] = is_final_turn
        result["transcript"] = snapshot
        empty_finalized = {}
        finalized = _core_get(state, "finalized_turns", empty_finalized)
        finalized[turn_id] = is_final_turn
        state["finalized_turns"] = finalized
    else:
        pass
    is_speech_complete = _core_eq(type, "speechComplete")
    if is_speech_complete:
        empty_turns = {}
        turns = _core_get(state, "turns", empty_turns)
        previous = _core_get(turns, turn_id, "")
        complete = _core_get(event, "transcript", previous)
    ...
    results.append(result)
    empty_state = {}
    turns = _core_get(state, "turns", empty_state)
    finalized = _core_get(state, "finalized_turns", empty_state)
    emitted = _core_get(state, "emitted_turns", empty_state)
    ids = _core_map_keys(turns)
    ready = True
    for id in ids:
        is_final_turn = _core_get(finalized, id, False)
        ready = _core_and(ready, is_final_turn)
        sent = _core_get(emitted, id, False)
        unsent = _core_not(sent)
        emit = _core_and(ready, unsent)
        if emit:
            committed = {}
            committed["index"] = 0
            committed["id"] = id
            text = _core_get(turns, id, "")
            committed["content"] = text
            calls = []
            committed["function_calls"] = calls
            committed["finish_reason"] = none_finish
            snapshot = {}
            snapshot["text"] = text
            snapshot["is_final"] = True
            committed["transcript"] = snapshot
            speaker = _core_get(speakers, id, None)
            has_speaker = _core_is_not_none(speaker)
            if has_speaker:
                committed["name"] = speaker
            else:
                pass
            is_current = _core_eq(id, turn_id)
            if is_current:
                result["content"] = text
            else:
            ...
            pass
    state["emitted_turns"] = emitted
    out = {}
    out["results"] = results
    stable_session = _core_get(state, "session_id", session)
    has_stable_session = _core_is_not_none(stable_session)
    if has_stable_session:
        out["remote_session_id"] = stable_session
    else:
        pass
    usage = _core_none()
...
def provider_finalize_realtime_response(profile: str, state: Any, fallback: Any) -> AxChatResponse:
    _core_coverage_mark("provider_finalize_realtime_response")
    is_meta = _core_eq(profile, "meta")
    if is_meta:
        results = []
        empty_turns = {}
        turns = _core_get(state, "turns", empty_turns)
        speakers = _core_get(state, "speakers", empty_turns)
        ids = _core_map_keys(turns)
        for id in ids:
            result = {}
            index = _core_len(results)
            result["index"] = index
            result["id"] = id
            text = _core_get(turns, id, "")
            result["content"] = text
        ...
        session = _core_get(state, "session_id", None)
        fallback["remote_session_id"] = session
        fallback["remote_id"] = session
    else:
        pass
    return fallback


def provider_realtime_terminal_response(response: Any) -> AxChatResponse:
    _core_coverage_mark("provider_realtime_terminal_response")
    empty = {}
    out = _core_map_merge(response, empty)
    results = _core_get(response, "results", None)
    terminal_results = []
    for result in results:
        terminal = _core_map_merge(result, empty)
        terminal["content"] = ""
        _core_map_delete(terminal, "audio")
        calls = []
        terminal["function_calls"] = calls
        terminal_results.append(terminal)
    out["results"] = terminal_results
    return out
...
def _gemini_build_chat_request(request: AxChatRequest, options: Any, is_vertex: bool) -> Any:
    ...
    is_gemini38_flash = _core_eq(model, "gemini-3.8-flash")
    ...
    server_managed_sampling_37 = _core_or(is_gemini38_flash, is_gemini37_flash)
    strict_flash_parameters = _core_or(server_managed_sampling_37, is_gemini36_flash)
    server_managed_sampling = _core_or(strict_flash_parameters, is_gemini35_flash_lite)
    generation_config = {}
    legacy_candidate_count = _core_not(strict_flash_parameters)
    if legacy_candidate_count:
    ...
    empty_model_config = {}
    model_config = _core_get(request, "model_config", empty_model_config)
    _gemini_apply_model_config_impl(generation_config, model, model_config, server_managed_sampling, strict_flash_parameters)
    response_format = _core_get(request, "response_format", None)
    has_response_format = _core_truthy(response_format)
    if has_response_format:
...
def _gemini_clamp_thinking_level_impl(model: str, level: str) -> str:
    ...
    if is_legacy_pro:
        ...
        pass
    is_38_flash = _core_contains(model, "gemini-3.8-flash")
    is_37_flash = _core_contains(model, "gemini-3.7-flash")
    is_current_flash = _core_or(is_38_flash, is_37_flash)
    is_31_pro = _core_contains(model, "gemini-3.1-pro")
    no_minimal_name = _core_or(is_current_flash, is_31_pro)
...
def _gemini_apply_model_config_impl(payload: Any, model: str, model_config: Any, server_managed_sampling: bool, strict_flash_parameters: bool) -> None:
    ...
    if client_managed_sampling:
        ...
        pass
    legacy_parameters = _core_not(strict_flash_parameters)
...
def _anthropic_build_chat_request(request: AxChatRequest, supports_none: bool) -> Any:
    ...
    if has_functions:
        ...
        for fn in functions:
            ...
            tools.append(tool)
        payload["tools"] = tools
        tool_choice = _anthropic_tool_choice_impl(request, supports_none)
...
def _anthropic_content_part_impl(part: Any) -> Any:
    ...
    if is_audio:
        ...
        source["type"] = "base64"
        format = _core_get(part, "format", "wav")
        media_type = _core_string_format("audio/{}", format)
    ...
    if is_file:
        ...
        file_uri_snake = _core_get(part, "file_uri", None)
        file_uri = _core_get(part, "fileUri", file_uri_snake)
        has_file_uri = _core_truthy(file_uri)
        if has_file_uri:
            source["type"] = "url"
            source["url"] = file_uri
        else:
...
def _anthropic_tool_choice_impl(request: Any, supports_none: bool) -> Any:
...
def provider_session_route(entry: Any, request: Any, options: Any) -> Any:
    _core_coverage_mark("provider_session_route")
    empty = {}
    request = _core_map_merge(request, empty)
    options = _core_map_merge(options, empty)
    model = _core_get(entry, "model", None)
    has_model = _core_is_not_none(model)
    if has_model:
        request["model"] = model
        options["model"] = model
    else:
        _core_map_delete(request, "model")
        _core_map_delete(options, "model")
    out = {}
    out["request"] = request
    out["options"] = options
    return out
...
def provider_chat_profile(profile: str, model: str) -> str:
    _core_coverage_mark("provider_chat_profile")
    normalized = provider_normalize_profile(profile)
    official = _core_eq(normalized, "openai")
    astra = _core_string_starts_with(model, "gpt-6-astra")
    route = _core_and(official, astra)
    if route:
...
def provider_chat_operation_path(profile: str, model: str, operation: str, path: str) -> str:
    _core_coverage_mark("provider_chat_operation_path")
    resolved = provider_chat_profile(profile, model)
    normalized = provider_normalize_profile(profile)
    changed = _core_ne(resolved, normalized)
    chat = _core_eq(operation, "chat")
    stream = _core_eq(operation, "stream_chat")
    chat_op = _core_or(chat, stream)
    route = _core_and(changed, chat_op)
    if route:
        return "/responses"
    else:
        pass
...
def openai_responses_apply_astra_caching(payload: Any, request: Any, options: Any) -> Any:
    _core_coverage_mark("openai_responses_apply_astra_caching")
    model = _core_get(payload, "model", "")
    astra = _core_string_starts_with(model, "gpt-6-astra")
    other = _core_not(astra)
    if other:
        return payload
    else:
        pass
    empty = []
    snake = _core_map_contains(options, "context_cache")
    camel = _core_map_contains(options, "contextCache")
    enabled = _core_or(snake, camel)
    prompt = _core_get(request, "chat_prompt", empty)
    functions = _core_get(request, "functions", empty)
    for message in prompt:
        cache = _core_get(message, "cache", False)
        enabled = _core_or(enabled, cache)
    for function in functions:
        cache = _core_get(function, "cache", False)
        enabled = _core_or(enabled, cache)
    if enabled:
        input = _core_get(payload, "input", empty)
        marked_input = []
        for item in input:
            parts = _core_get(item, "content", empty)
            is_list = _core_type_is(parts, "list")
            if is_list:
                count = _core_len(parts)
                has_parts = _core_gt(count, 0)
                if has_parts:
                    index = _core_add(count, -1)
                    part = _core_list_get(parts, index, None)
                    marker = {}
                    ...
                    for original_part in parts:
                        last_part = _core_eq(part_index, index)
                        if last_part:
                            marked_parts.append(part)
                        else:
                            marked_parts.append(original_part)
                        part_index = _core_add(part_index, 1)
                    item["content"] = marked_parts
                else:
                    pass
            else:
                pass
            marked_input.append(item)
        payload["input"] = marked_input
        cache_options = {}
        cache_options["mode"] = "explicit"
        cache_options["ttl"] = "30m"
        payload["prompt_cache_options"] = cache_options
        key_snake = _core_get(options, "prompt_cache_key", None)
        key = _core_get(options, "promptCacheKey", key_snake)
        session_snake = _core_get(options, "session_id", None)
        session = _core_get(options, "sessionId", session_snake)
        resolved_key = _core_coalesce(key, session)
        has_key = _core_is_not_none(resolved_key)
        if has_key:
            payload["prompt_cache_key"] = resolved_key
        else:
            pass
...
def openai_responses_transport_cursor(state: Any, event: Any) -> Any:
    _core_coverage_mark("openai_responses_transport_cursor")
    empty = {}
    seen = _core_get(state, "seen", empty)
    response = _core_get(event, "response", empty)
    id = _core_get(response, "id", None)
    kind = _core_get(event, "type", "")
    created = _core_eq(kind, "response.created")
    if created:
        known = _core_map_contains(seen, id)
        if known:
            pass
        else:
            seen[id] = True
        ...
        pass
    terminals = []
    terminals.append("response.completed")
    terminals.append("response.incomplete")
    terminals.append("response.failed")
    terminals.append("response.cancelled")
    terminal = _core_contains(terminals, kind)
    if terminal:
        seen[id] = True
        active = _core_get(state, "active_id", None)
        same = _core_eq(active, id)
        if same:
            _core_map_delete(state, "active_id")
        else:
            pass
    else:
        pass
...
def openai_responses_session_event(event: Any, state: Any, model: str) -> list[Any]:
    _core_coverage_mark("openai_responses_session_event")
    events = []
    empty_map = {}
    kind = _core_get(event, "type", "")
    response = _core_get(event, "response", empty_map)
    created = _core_eq(kind, "response.created")
    if created:
        id = _core_get(response, "id", None)
        ...
        pass
    response_id = _core_get(state, "response_id", None)
    done = _core_eq(kind, "response.output_item.done")
    if done:
        item = _core_get(event, "item", None)
        item_type = _core_get(item, "type", None)
        is_function = _core_eq(item_type, "function_call")
        if is_function:
            id = _core_get(item, "call_id", None)
            seen = _core_get(state, "seen_calls", empty_map)
            duplicate = _core_map_contains(seen, id)
            new_event = _core_not(duplicate)
            if new_event:
                call = _openai_responses_function_call_impl(item)
                notification = {}
                notification["type"] = "tool.call"
                notification["response_id"] = response_id
                notification["call"] = call
                events.append(notification)
                seen[id] = True
                state["seen_calls"] = seen
            else:
                pass
        else:
            pass
        ...
        pass
    completed = _core_eq(kind, "response.completed")
    incomplete = _core_eq(kind, "response.incomplete")
    details = _core_get(response, "incomplete_details", empty_map)
    reason = _core_get(details, "reason", None)
    steered = _core_eq(reason, "steered")
    steered_end = _core_and(incomplete, steered)
    boundary = _core_or(completed, steered_end)
    if boundary:
        id = _core_get(response, "id", None)
        state["response_id"] = id
        seen = _core_get(state, "seen_responses", empty_map)
        duplicate = _core_map_contains(seen, id)
        new_event = _core_not(duplicate)
        if new_event:
            normalized = openai_responses_normalize_chat_response(response, "openai-responses", model)
            notification = {}
            notification["type"] = "response.completed"
            notification["response_id"] = id
            notification["response"] = normalized
            events.append(notification)
            seen[id] = True
            state["seen_responses"] = seen
        else:
            pass
        return events
    else:
        pass
    failed = _core_eq(kind, "response.failed")
    error = _core_eq(kind, "error")
    failure = _core_or(failed, error)
    failure = _core_or(failure, incomplete)
    if failure:
        message = _core_json_stringify(event)
        message = _core_string_format("Responses session failed: {}", message)
        session_error = _core_runtime_error(message)
        raise session_error
    else:
        pass
    accepted = _core_eq(kind, "response.steer.accepted")
    pending = _core_eq(kind, "response.steer.pending")
    rejected = _core_eq(kind, "response.steer.failed")
    steering = _core_or(accepted, pending)
    steering = _core_or(steering, rejected)
    if steering:
        steer = _core_get(event, "steer", empty_map)
        sequence = _core_get(event, "sequence_number", None)
        id = _core_get(steer, "id", sequence)
        empty_list = []
        required = _core_get(event, "required_input", empty_list)
        required_key = _core_json_stringify(required)
        key = _core_string_format("{}:{}:{}", kind, id, required_key)
        seen = _core_get(state, "seen_steering", empty_map)
        ...
        if duplicate:
            ...
            pass
        seen[key] = True
        state["seen_steering"] = seen
        notification = {}
        notification["type"] = "steering"
        notification["steer_id"] = id
        parent = _core_get(steer, "previous_response_id", None)
        notification["response_id"] = parent
        notification["status"] = "accepted"
        if pending:
            notification["status"] = "pending"
            ids = []
            for input in required:
                call_id = _core_get(input, "call_id", None)
                has_id = _core_truthy(call_id)
                if has_id:
                    ids.append(call_id)
                else:
                    pass
            notification["required_call_ids"] = ids
        else:
            pass
        if rejected:
            notification["status"] = "failed"
            error_object = _core_get(event, "error", empty_map)
            message = _core_get(error_object, "message", None)
        ...
        pass
    text = _core_eq(kind, "response.output_text.delta")
    if text:
        normalized = openai_responses_normalize_stream_delta(event, state, "openai-responses", model)
        notification = {}
...
def openai_responses_validate_session_request(request: Any) -> Any:
    _core_coverage_mark("openai_responses_validate_session_request")
    model = _core_get(request, "model", "")
    astra = _core_string_starts_with(model, "gpt-6-astra")
    empty = {}
    reasoning = _core_get(request, "reasoning", empty)
    effort = _core_get(reasoning, "effort", None)
    has_effort = _core_is_not_none(effort)
    validate_effort = _core_and(astra, has_effort)
    if validate_effort:
        openai_responses_validate_astra_effort(effort)
    else:
        pass
    empty_input = []
    input = _core_get(request, "input", empty_input)
    is_list = _core_type_is(input, "list")
    if is_list:
        previous_update = False
        for item in input:
            type = _core_get(item, "type", None)
            update = _core_eq(type, "configuration_update")
            if update:
                if previous_update:
                    raise RuntimeError("Adjacent configuration_update items are not supported")
                else:
                    pass
                truncation = _core_get(request, "truncation", None)
                automatic_truncation = _core_eq(truncation, "auto")
                management = _core_get(request, "context_management", None)
                compaction = _core_truthy(management)
                agents_value = _core_get(request, "agents", None)
                agents = _core_truthy(agents_value)
                mode = _core_get(reasoning, "mode", None)
                pro = _core_eq(mode, "pro")
                wrong_model = _core_not(astra)
                incompatible = _core_or(wrong_model, automatic_truncation)
                incompatible = _core_or(incompatible, compaction)
                incompatible = _core_or(incompatible, agents)
                incompatible = _core_or(incompatible, pro)
                if incompatible:
                    raise RuntimeError("configuration_update requires GPT-6 Astra in standard single-agent mode without automatic compaction or truncation")
                else:
                    pass
                update_reasoning = _core_get(item, "reasoning", empty)
                update_effort = _core_get(update_reasoning, "effort", None)
                openai_responses_validate_astra_effort(update_effort)
            else:
                pass
...
def openai_responses_validate_astra_effort(effort: Any) -> None:
    _core_coverage_mark("openai_responses_validate_astra_effort")
    low = _core_eq(effort, "low")
    medium = _core_eq(effort, "medium")
    high = _core_eq(effort, "high")
    xhigh = _core_eq(effort, "xhigh")
    max = _core_eq(effort, "max")
    valid = _core_or(low, medium)
    valid = _core_or(valid, high)
    valid = _core_or(valid, xhigh)
    valid = _core_or(valid, max)
    invalid = _core_not(valid)
    if invalid:
