...
def provider_build_transcribe_request(profile: str, request: Any) -> Any:
    ...
    if is_responses:
        ...
        error = _core_ai_error_unsupported("transcribe is not supported by this generated AxAI beta provider")
        raise error
    return payload
...
def provider_build_speak_request(profile: str, request: Any) -> Any:
    ...
    if is_responses:
        ...
        error = _core_ai_error_unsupported("speak is not supported by this generated AxAI beta provider")
        raise error
    return payload
...
def _anthropic_thinking_config_impl(model: str, level: str) -> Any:
    ...
    is_adaptive = _core_or(is_47_plus, is_46)
    if is_adaptive:
        thinking = {}
