...
public final class DeepSeekResponsesClient extends OpenAICompatibleClient {
  public DeepSeekResponsesClient(String model) {
    this(Map.of("model", model));
  }

  public DeepSeekResponsesClient(Map<String, Object> options) {
    super("deepseek-responses", "DeepSeek Responses", normalize(options), "deepseek-v4-flash", "");
  }
