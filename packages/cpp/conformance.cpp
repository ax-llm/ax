...
static void run_ai_cancellation(Value fixture) {
  auto reason=display(Core::get(fixture,"reason","fixture-stop"));auto request=Core::get(fixture,"request",Value::object());auto max_elapsed=static_cast<long>(Core::number(Core::get(fixture,"max_elapsed_ms",1000)));
