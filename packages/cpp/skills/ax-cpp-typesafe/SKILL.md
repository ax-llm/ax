...
```cpp
auto model = axllm::ai("typesafe", axllm::object({{"api_key", api_key}, {"trueThreshold", 0.9}}));
auto triage = axllm::ax("ticket:string -> urgent:boolean(true \"Core task blocked\", false \"Routine request\"), team:class \"support, billing, engineering\"");
