...
- `axir-2026-07-12-agent-improve-weakness-mining-repair` [axagent] Port agent.improve() — failure-driven repair with regression-validated acceptance
  - Status: open
  - TS paths: `src/ax/agent/agentInternal/improve/improve.ts`, `src/ax/agent/agentInternal/improve/improveTypes.ts`, `src/ax/agent/agentInternal/improve/evalHarness.ts`, `src/ax/agent/agentInternal/improve/failureClusters.ts`, `src/ax/agent/agentInternal/improve/weaknessMiner.ts`, `src/ax/agent/agentInternal/improve/proposals.ts`, `src/ax/agent/agentInternal/coordinator.ts`, `src/ax/agent/agentInternal/pipelineForwardForEvaluation.ts`, `src/ax/agent/agentInternal/agentOptimizeTypes.ts`, `src/ax/agent/agentInternal/signatureBuilders.ts`, `src/ax/agent/AxAgent.ts`
