...
async function renderContext(language, page) {
  ...
  const context = {
    ...
    flowBranchExample: snippetBlock(language, 'flow.branch', 'flow'),
    flowParallelExample: snippetBlock(language, 'flow.parallel', 'flow'),
    ...
    mcpMRTRExample: snippetBlock(language, 'mcp.mrtrElicitation'),
...
function builtInSnippet(languageId, key) {
  const ts = {
    ...
    'flow.branch': {
      sourcePath: 'src/examples/typescript/flows/branch-flow.ts',
      verified: true,
    ...
    'flow.parallel': {
      sourcePath: 'src/examples/typescript/flows/parallel-flow.ts',
      verified: true,
      requiresCredentials: true,
      code: [
    ...
    'flow.refine': {
      sourcePath: 'src/examples/typescript/flows/refine-flow.ts',
      verified: true,
      requiresCredentials: true,
      code: [
        'const workflow = flow<{ topicText: string }>()',
...
function generatedPackageSnippets(languageId) {
  ...
  return {
    ...
    'flow.branch': base['flow.branch'] ?? base.default,
    'flow.parallel': base['flow.parallel'] ?? base.default,
    'flow.refine': base['flow.refine'] ?? base.default,
